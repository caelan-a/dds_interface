...
/*
 * @(#)cdr_log.h    generated by: makeheader    Fri Nov 15 12:22:08 2019
 *
 *		built from:	log.ifc
 */
...
#define RTICdrLog_logWithFunctionName(INSTRUMENT_BIT, METHOD_NAME_IN, ...) \
    RTILog_logWithFunctionName( \
        MODULE_CDR, \
