...
/*
 * @(#)transport_tls_openssl.h    generated by: makeheader    Fri Nov 15 12:23:54 2019
 *
...
struct NDDS_Transport_TLS_Ciphers {
    /*e \brief List of available (D)TLS ciphers
     *
...
extern	int NDDS_Transport_TLS_verbose_verify_callback(int ok, X509_STORE_CTX *store);
