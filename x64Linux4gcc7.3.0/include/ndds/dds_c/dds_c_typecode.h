...
/*
 * @(#)dds_c_typecode.h    generated by: makeheader    Fri Nov 15 12:22:54 2019
 *
...
typedef struct {
    /*e \dref_TypeCodePrintFormatProperty_indent */
    DDS_Long indent;
    /*e \dref_TypeCodePrintFormatProperty_print_ordinals */
    DDS_Boolean print_ordinals;
} DDS_TypeCodePrintFormatProperty;


/*e \dref_TypeCode_PrintFormat_INITIALIZER */
...
struct DDS_TYPECODE_DLL_EXPORT DDS_TypeCode {
    ...
    /*e \dref_TypeCode_to_string */
    void to_string(
        char *str,
        DDS_UnsignedLong &str_size,
        DDS_ExceptionCode_t & ex) const;

    /*e \dref_TypeCode_to_string_w_format */
    void to_string(
        char *str,
        DDS_UnsignedLong &str_size,
...
/* ----------------------------------------------------------------- */
/*ce \dref_TypeCode_extensibility_kind
 */ 
...
/* ----------------------------------------------------------------- */
/*ci \dref_TypeCode_extensibility_kind
 */
...
/* ----------------------------------------------------------------- */
/*ce \dref_TypeCode_default_annotation
 */   
extern DDSCDllExport
...
/* ----------------------------------------------------------------- */
/*ce \dref_TypeCode_member_default_annotation
 */   
extern DDSCDllExport
...
/* ----------------------------------------------------------------- */
/*ce \dref_TypeCode_min_annotation
 */   
extern DDSCDllExport
...
/* ----------------------------------------------------------------- */
/*ce \dref_TypeCode_max_annotation
 */   
extern DDSCDllExport
...
/* ----------------------------------------------------------------- */
/*ce \dref_TypeCode_find_member_by_name
 */
...
/* ----------------------------------------------------------------- */
/*ce \dref_TypeCode_member_label_count
 *
 * \internal
 * NDDS EXTENSION
 */
...
/* ----------------------------------------------------------------- */
/*ce \dref_TypeCode_member_ordinal
 *
 * \internal
 * NDDS EXTENSION
 */ 
...
/* ----------------------------------------------------------------- */
/*ci \dref_TypeCode_find_member_by_label
 *
 * \internal
 * NDDS EXTENSION
 */
...
/* ----------------------------------------------------------------- */
/*ci \dref_TypeCode_get_member_flags
 *
 * \internal
 * NDDS EXTENSION
 */
...
/* ----------------------------------------------------------------- */
/*ce \dref_TypeCode_is_member_key
 *
 * \internal
 * NDDS EXTENSION
 */
...
/* ----------------------------------------------------------------- */
/*ce \dref_TypeCode_is_member_required
 *
 * \internal
 * NDDS EXTENSION
 */
...
/* ----------------------------------------------------------------- */
/*ce \dref_TypeCode_is_member_pointer
 *
 * \internal
 * NDDS EXTENSION
 */   
...
/* ----------------------------------------------------------------- */
/*ce \dref_TypeCode_is_member_bitfield
 *
 * \internal
 * NDDS EXTENSION
 */   
...
/* ----------------------------------------------------------------- */
/*ce \dref_TypeCode_member_bitfield_bits
 *
 * \internal
 * NDDS EXTENSION
 */   
...
/* ----------------------------------------------------------------- */
/*ce \dref_TypeCode_member_visibility
 */
...
/* ----------------------------------------------------------------- */
/*ce \dref_TypeCode_discriminator_type
 */       
...
/* ----------------------------------------------------------------- */
/*ce \dref_TypeCode_array_dimension_count
 *
 * \internal
 * NDDS EXTENSION
 */  
...
/* ----------------------------------------------------------------- */
/*ce \dref_TypeCode_array_dimension
 *
 * \internal
 * NDDS EXTENSION
 */  
...
/* ----------------------------------------------------------------- */
/*ce \dref_TypeCode_element_count
 */        
...
/* ----------------------------------------------------------------- */
/*ce \dref_TypeCode_is_alias_pointer
 */ 
/*
 * NDDS EXTENSION
 */   
...
/* ----------------------------------------------------------------- */
/*ce \dref_TypeCode_default_index
 */ 
...
/* ----------------------------------------------------------------- */
/*ce \dref_TypeCode_concrete_base_type
 */
...
/* ----------------------------------------------------------------- */
/*ce \dref_TypeCode_type_modifier
 */
...
/* ----------------------------------------------------------------- */
/*ce \dref_TypeCode_find_member_by_id
 *
 * \internal
 * NDDS EXTENSION for sparse type members
 */   
...
/* ----------------------------------------------------------------- */
/*ci \dref_TypeCode_find_member_by_idI
 *
 * \internal
 * NDDS EXTENSION for sparse type members
 */   
...
/* ----------------------------------------------------------------- */
/*ci \dref_TypeCode_member_representation_count
 *
 * \internal
 * NDDS EXTENSION for sparse type members
 */   
...
/* ----------------------------------------------------------------- */
/*ci \dref_TypeCode_member_representation_id
 *
 * \internal
 * NDDS EXTENSION for sparse type members
 */   
...
/* ----------------------------------------------------------------- */
/*ci \dref_TypeCode_is_member_representation_pointer
 *
 * \internal
 * NDDS EXTENSION for sparse type members
 */   
...
/* ----------------------------------------------------------------- */
/*ci \dref_TypeCode_is_member_representation_bitfield
 *
 * \internal
 * NDDS EXTENSION for sparse type members
 */   
...
/* ----------------------------------------------------------------- */
/*ci \dref_TypeCode_member_representation_bitfield_bits
 *
 * \internal
 * NDDS EXTENSION for sparse type members
 */   
...
/* ----------------------------------------------------------------- */
/*ci \dref_TypeCode_member_representation_type
 *
 * \internal
 * NDDS EXTENSION for sparse type members
 */   
...
/* ----------------------------------------------------------------- */
/*ci \dref_TypeCode_get_serialized_size
 *
 * \internal
 * NDDS EXTENSION
 */   
...
/* ----------------------------------------------------------------- */
/*ce \dref_TypeCode_get_type_object_serialized_size
 */   
...
/* ----------------------------------------------------------------- */
/*ce \dref_TypeCode_add_member_to_enum
 */   
...
/* ----------------------------------------------------------------- */
/*ce \dref_TypeCode_add_member_to_union
 */   
...
/* ----------------------------------------------------------------- */
/*ce \dref_TypeCode_add_member_ex
 *
 * \internal
 * NDDS EXTENSION
 */   
...
/* ----------------------------------------------------------------- */
/*ci \dref_TypeCode_add_representation
 *
 * \internal
 * NDDS EXTENSION for sparse types
 */   
...
/* ----------------------------------------------------------------- */
/*ci \dref_TypeCode_add_representation_ex
 *
 * \internal
 * NDDS EXTENSION for sparse types
 */   
...
/* ----------------------------------------------------------------- */
/*ce \dref_TypeCode_print_IDL
 */ 
extern DDSCDllExport void DDS_TypeCode_print_IDL(
        const DDS_TypeCode *self,
...
/* ----------------------------------------------------------------- */
/*ce \dref_TypeCode_to_string
 */ 
extern DDSCDllExport void DDS_TypeCode_to_string(
        const DDS_TypeCode *self,
        char *str,
        DDS_UnsignedLong *str_size,
        DDS_ExceptionCode_t *ex);
...
/* ----------------------------------------------------------------- */
/*ce \dref_TypeCode_to_string_w_format
 */ 
extern DDSCDllExport void DDS_TypeCode_to_string_w_format(
        const DDS_TypeCode *self,
        char *str,
        DDS_UnsignedLong *str_size,
        const DDS_TypeCodePrintFormatProperty *format,
...
/* ----------------------------------------------------------------- */
/*ci \dref_TypeCode_has_mutable_aggregation_type
 *
 * \internal
 * NDDS EXTENSION
 */
...
/* ----------------------------------------------------------------- */
/*ci \dref_DDS_TypeCode_is_unbounded
 *
 * \internal
 * NDDS EXTENSION
 */
...
/*ce \dref_TypeCodeFactory_get_instance
 */
extern DDSCDllExport DDS_TypeCodeFactory * DDS_TypeCodeFactory_get_instance();


/*ce \dref_TypeCodeFactory_finalize_instance
 * @brief If there is no DDS_DomainParticipantFactory instances left in the
 * system, it will finalize the DDS_TypeCodeFactory. If there is at least one
 * DDS_DomainParticipantFactory instance left in the system, this is a noop.
 */
extern DDSCDllExport
DDS_ReturnCode_t DDS_TypeCodeFactory_finalize_instance();


/*ce \dref_TypeCodeFactory_clone_tc
*/
...
/*ci \dref_TypeCodeFactory_clone_tc_optimizedI 
 * @brief clone a TypeCode. The returned TypeCode is an IndexedTypecode, with
 * fast lookups by name and by id
 * 
 * @param tc The TypeCode to clone
 * 
 * @param minimalTc if TRUE then all pointers and aliases will be stripped from
 * the clonedTc as these do not provide any information that is required for
...
/*ce \dref_DDS_TypeCodeFactory_clone_tc_with_optimization_level
 *
 * @brief Creates a new typecode from a passed one by applying a given
 * optimization level.
 *
 * @param self TypeCodeFactory.
 * @param type_code Typecode to clone according to the passed
 * optimization level.
 * @param optimization_level Optimization level of the resulting typecode.
...
/*ce \dref_TypeCodeFactory_delete_tc
 *
 * @brief Destroys a passed typecode.
 *
 * @param self TypeCodeFactory.
 * @param tc Typecode to destroy.
 * @param ex Exception code.
 *
 */
extern DDSCDllExport
...
/*ce \dref_TypeCodeFactory_get_primitive_tc
*/
...
/*ce \dref_TypeCodeFactory_create_struct_tc
*/
...
/*ce \dref_TypeCodeFactory_create_struct_tc_ex
*/
...
/*ce \dref_TypeCodeFactory_create_value_tc
*/
...
/*ce \dref_TypeCodeFactory_create_value_tc_ex
*/
...
/*ce \dref_TypeCodeFactory_create_union_tc
*/
...
/*ce \dref_TypeCodeFactory_create_union_tc_ex
*/
...
/*ce \dref_TypeCodeFactory_create_enum_tc
*/
...
/*ce \dref_TypeCodeFactory_create_enum_tc_ex
*/
...
/*ce \dref_TypeCodeFactory_create_alias_tc
*/
...
/*ce \dref_TypeCodeFactory_create_string_tc
*/
...
/*ce \dref_TypeCodeFactory_create_wstring_tc
*/
...
/*ce \dref_TypeCodeFactory_create_sequence_tc
*/
...
/*ce \dref_TypeCodeFactory_create_array_tc
*/
...
/*ci \dref_TypeCodeFactory_create_sparse_tc
*/
...
/*ci \dref_TypeCodeFactory_create_raw_bytes_tc
*/
