...
/*
 * @(#)commend_writerService.h    generated by: makeheader    Fri Nov 15 12:22:18 2019
 *
...
struct COMMENDWriterServiceWriterProperty {
    ...
    */
    ...
    /*
     * Indicates if multichannel data fragmentation is supported. 
     * This property is temporarily needed because TopicQuery requires
     * multichannel and there are customers with large data requirements using 
     * TopicQueries.
     * 
     * Note that once CORE-9335 is addressed this property can be removed
     * or deprecated
     * 
     * This boolean is set based on the value of the internal property:
     * dds.data_writer.protocol.allow_multichannel_fragmentation
     */
    RTIBool allowMultichannelFragmentation;
  ...
  #define COMMEND_WRITER_SERVICE_WRITER_PROPERTY_DEFAULT {  \
    ...
    RTI_FALSE, /* allowMultichannelFragmentation */ \
