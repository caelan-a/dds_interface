...
/*
 * @(#)osapi_thread.h    generated by: makeheader    Fri Nov 15 12:21:39 2019
 *
...
extern RTIOsapiDllExport
void RTIOsapiThread_disableDumpBacktraceSupport(void);

extern RTIOsapiDllExport
RTIBool RTIOsapiThread_enableDumpBacktraceSupport(void);

extern RTIOsapiDllExport
RTIBool RTIOsapiThread_installSigsegvHandler(void);

extern RTIOsapiDllExport
void RTIOsapiThread_dumpBacktrace(RTILogBitmap logLevel);


#if ((defined(RTI_DARWIN) || defined(RTI_WIN32) || defined(RTI_LINUX)) \
    && !defined(RTI_ANDROID))
  #define RTI_OSAPI_DUMP_BACKTRACE_SUPPORTED 1
#else
  #define RTI_OSAPI_DUMP_BACKTRACE_SUPPORTED 0
#endif
...
#else
  #define RTI_OSAPI_SIGNAL_HANDLER_SUPPORTED 0
#endif
 ...
 */
#define RTI_OSAPI_THREAD_NAME_MAX_LENGTH 16
