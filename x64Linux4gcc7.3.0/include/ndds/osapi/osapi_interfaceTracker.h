...
/*
 * @(#)osapi_interfaceTracker.h    generated by: makeheader    Fri Nov 15 12:21:40 2019
 *
...
struct RTIOsapiInterfaceTrackerProperty {
    ...
    char threadName[RTI_OSAPI_THREAD_NAME_MAX_LENGTH];
};
...
#define RTI_OSAPI_INTERFACE_TRACKER_PROPERTY_DEFAULT {                         \
        RTI_OSAPI_SOCKET_AF_INET,                             /* autoIdKind */ \
        RTI_OSAPI_INTERFACE_TRACKER_DETECTION_KIND_AUTO,   /* detectionKind */ \
        0,                                                 /* interfaceMask */ \
        0,                                           /* interfacePollPeriod */ \
        "",                                                   /* threadName */ \
}
