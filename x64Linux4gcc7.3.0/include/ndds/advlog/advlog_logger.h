...
/*
 * @(#)advlog_logger.h    generated by: makeheader    Fri Nov 15 12:21:55 2019
 *
...
extern ADVLOGDllExport
RTILogPrintBitmap ADVLOGLogger_getPrintMask(
        struct REDAWorker *worker,
        RTIBool workerSpecific);

extern ADVLOGDllExport
RTILogPrintBitmap ADVLOGLogger_getPrintMaskByLogLevel(
        RTILogLevel logLevel,
        struct REDAWorker *worker,
        RTIBool workerSpecific);
