...
public:
     ...
     * topic name.
     *
     * @param profile The profile where the QosProvider should look for the TopicQos
     ...
     * name and topic name
     *
     * @param profile The profile where the QosProvider should look for the DataReaderQos
     * @param topic_name The topic name used to select a qos within the profile,
     * if the `topic_filter` attribute is used
     *
     ...
     * name and topic name.
     *
     * @param profile The profile where the QosProvider should look for the DataWriterQos
     * @param topic_name The topic name used to select a qos within the profile,
     * if the `topic_filter` attribute is used
     *
