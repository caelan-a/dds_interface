...
#ifndef ServiceAdminPlugin_1325755636_h
#define ServiceAdminPlugin_1325755636_h
        ...
        namespace Admin {
            ...
            * ---------------------------------------------------------------------------- */
            ...
            CommandActionKindPluginSupport_print_data(
                const CommandActionKind *sample, const char *desc, int indent_level);
            ...
            * ---------------------------------------------------------------------------- */
            ...
            CommandReplyRetcodePluginSupport_print_data(
                const CommandReplyRetcode *sample, const char *desc, int indent_level);
...
#endif /* ServiceAdminPlugin_1325755636_h */
