...
#ifndef ServiceCommonPlugin_1902812022_h
#define ServiceCommonPlugin_1902812022_h
    ...
    namespace Service {
        ...
        * ---------------------------------------------------------------------------- */
        ...
        EntityStateKindPluginSupport_print_data(
            const EntityStateKind *sample, const char *desc, int indent_level);
        ...
        namespace Monitoring {
            ...
            * ---------------------------------------------------------------------------- */
            ...
            DistributionTopicKindPluginSupport_print_data(
                const DistributionTopicKind *sample, const char *desc, int indent_level);
            ...
            * ---------------------------------------------------------------------------- */
            ...
            ResourceKindIndexPluginSupport_print_data(
                const ResourceKindIndex *sample, const char *desc, int indent_level);
            ...
            * ---------------------------------------------------------------------------- */
            ...
            ResourceKindPluginSupport_print_data(
                const ResourceKind *sample, const char *desc, int indent_level);
...
#endif /* ServiceCommonPlugin_1902812022_h */
