...
public:
    ...
    static void copy(native_type& destination, const native_type& source)
    {
        ...
        destination.instance_history = source.instance_history;
    }
    ...
    static bool equals(const native_type& first, const native_type& second)
    {
        ...
        return first.instance_history.depth == second.instance_history.depth;
    }
};
...
public:
    ...
    {
         native().sample_state =
                 static_cast<RTI_RecordingServiceSampleStateMask>(
                         state.to_ulong());
         return *this;
    }
    ...
    inline int32_t instance_history_depth() const
    {
        return native().instance_history.depth;
    }

    SelectorState& instance_history_depth(const int32_t depth)
    {
        native().instance_history.depth = (int) depth;
        return *this;
    }
