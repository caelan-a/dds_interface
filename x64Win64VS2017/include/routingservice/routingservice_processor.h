...
/*
 * @(#)routingservice_processor.h    generated by: makeheader    Fri Apr 23 01:06:17 2021
 *
...
struct RTI_RoutingServiceLoanedSamples {
    RTI_RoutingServiceSample *data_array;
    RTI_RoutingServiceSampleInfo *info_array;
    int length;
};


#define RTI_RoutingServiceLoanedSamples_INITIALIZER {\
    NULL,\
    NULL,\
    0 \
}
...
struct RTI_RoutingServiceInputImpl;


typedef struct RTI_RoutingServiceInputImpl RTI_RoutingServiceInput;
...
DDS_Boolean RTI_RoutingServiceInput_delete_content_query(
        RTI_RoutingServiceInput *self,
        RTI_RoutingServiceSelectorStateQueryData quey_data);


struct RTI_RoutingServiceOutputImpl;


typedef struct RTI_RoutingServiceOutputImpl RTI_RoutingServiceOutput;
