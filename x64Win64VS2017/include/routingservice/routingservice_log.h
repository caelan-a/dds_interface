...
/*
 * @(#)routingservice_log.h    generated by: makeheader    Fri Apr 23 01:06:16 2021
 *
 *		built from:	log.ifc
 */
...
extern ROUTERDllVariable
const struct RTILogMessage RTI_SERVICE_LOG_UNKNOWN_RESOURCE_ss;
...
#define RTI_ADVLOG_CONTEXT_DECLARE(DLL_EXPORT, CONTEXT_NAME) \
    extern DLL_EXPORT const struct ADVLOGContextTemplate CONTEXT_NAME
...
#define RTI_ADVLOG_CONTEXT_DEFINE(CONTEXT_NAME, STRING, LOG_NUMBER) \
    const struct ADVLOGContextTemplate CONTEXT_NAME = { \
...
RTI_ROUTER_ADVLOG_CONTEXT_DECLARE(RTI_SERVICE_ACTIVITY_RESUME_s);
RTI_ROUTER_ADVLOG_CONTEXT_DECLARE(RTI_SERVICE_ACTIVITY_SUSPEND_s);
