...
/*
 * @(#)recordingservice_storagewriter.h    generated by: makeheader    Fri Apr 23 01:05:41 2021
 *
...
typedef void (*RTI_RecordingServiceStorageStreamWriter_StoreFcn)(
        ...
        const RTI_RecordingServiceSample *samples,
        const RTI_RecordingServiceSampleInfo *sample_infos,
        const int count);
