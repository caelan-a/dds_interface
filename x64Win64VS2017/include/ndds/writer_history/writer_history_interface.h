...
/*
 * @(#)writer_history_interface.h    generated by: makeheader    Fri Apr 23 00:11:24 2021
 *
...
struct NDDS_WriterHistory_Property {
    ...
    */
    ...
    /*e
      \brief How many values to keep in the instance history. Note: The number
      of samples per instance delivered to a late joiner is determined by
      another property - durabilityWriterDepth, when durabilityWriterDepth != 0.
      For samples that were published after the reader was matched, the max
      number of un acknowledged samples can be upto historyDepth.
    */
    ...
    */
    ...
    /*e
      \brief The maximum number of samples per instance delivered to a late
      joiner. A durabilityWriterDepth of 0 implies the number of samples
      delivered to late joiner will be governed by history policy.
    */
    RTI_INT32 durabilityWriterDepth;
    /*e
...
#define WRITER_HISTORY_PROPERTY_DEFAULT { \
    ...
    0, /* durabilityWriterDepth - defaults to historyDepth*/ \
...
typedef enum {
    ...
    */
    ...
    /*e
      End coherency batch sample
    */
    NDDS_WRITERHISTORY_END_COHERENCY_BATCH_SAMPLE = 0x06
...
struct NDDS_WriterHistory_BatchStatus {
    ...
    */
    ...
    /*i
     * Identifies if the current batch was selected to be compressed.
     */
    RTIBool compressionEnabled;
};
...
struct NDDS_WriterHistory_Sample {
    ...
    */
    ...
    /* e
      \brief Number of samples in a coherent set. 
      
      This is set only for end coherent set samples.
    */
    RTI_INT32 coherentSetSampleCount; 
};
...
struct NDDS_WriterHistory_Statistics {
    ...
    /* Tracks samples dropped due to KEEP_LAST */
    RTI_INT64 replacedNonReclaimableSampleCount;
};


#define NDDS_WRITER_HISTORY_STATISTICS_INITIALIZER { \
    0, 0, /* sampleCount, sampleCountPeak */ \
    0, 0, /* aliveInstanceCount, aliveInstanceCountPeak */ \
    0, 0, /* disposedInstanceCount, disposedInstanceCountPeak */ \
    0, 0, /* unregisteredInstanceCount, unregisteredInstanceCountPeak */ \
    0 /* replacedNonReclaimableSampleCount */ \
}
...
#define NDDS_WRITERHISTORY_RETCODE_FLUSH_COMPRESSED_STREAM_NOT_NEEDED 16
...
struct NDDS_WriterHistory_WriteParams {
    ...
    struct MIGRtpsProductVersion relatedReaderProductVersion;
};
...
#define NDDS_WRITER_HISTORY_WRITE_PARAMS_DEFAULT { \
    ...
    MIGRtpsProductVersion_INITIALIZER \
}
...
typedef RTI_INT32 (*NDDS_WriterHistory_Plugin_FindSampleFcn)(
    ...
    const struct REDASequenceNumber *late_joiner_last_virtual_sn_in,
...
typedef RTI_INT32 (*NDDS_WriterHistory_Plugin_IsSampleWithinDurabilityWriterDepthFcn)(
    struct NDDS_WriterHistory_Plugin *self,
    RTIBool *isWithinDurabilityWriterDepth_out,
    NDDS_WriterHistory_Handle history_in,
    const struct NDDS_WriterHistory_Sample *sample_in);
...
struct NDDS_WriterHistory_Plugin {
    ...
    */
    ...
    /*e
    */
    NDDS_WriterHistory_Plugin_IsSampleWithinDurabilityWriterDepthFcn is_sample_within_durability_writer_depth;
};
 ...
 */
#define NDDS_WRITER_HISTORY_EXPECTED_MAX_INSTANCE_COUNT 16777216
#define NDDS_WRITER_HISTORY_EXPECTED_MAX_VIRTUAL_WRITERS_COUNT 65536
