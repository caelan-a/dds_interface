...
/*
 * @(#)osapi_cpu.h    generated by: makeheader    Fri Apr 23 00:09:52 2021
 *
 *		built from:	cpu.ifc
 */
...
#define RTIOsapiCpuBitmap_test(me, i) ((me)->mask[i>>5] & (RTI_UINT32) (1<<(i&0x1F)))
#define RTIOsapiCpuBitmap_set(me, i) do { \
    if (((me)->mask[i>>5] & (RTI_UINT32) (1<<(i&0x1F))) == 0) (me)->_numCpus++; \
    (me)->mask[i>>5] |= (RTI_UINT32) (1<<(i&0x1F)); \
} while (0)
