...
/*
 * @(#)osapi_ntptime_impl.h    generated by: makeheader    Fri Apr 23 00:09:55 2021
 *
...
#define RTINtpTime_toDouble(t) \
   (((double)((t)->frac)/4294967296.0) + (double)(t)->sec)

#define RTINtpTime_toInt64(__t) \
   ((((RTI_INT64)(__t)->sec) << 32) | ((RTI_INT64)(__t)->frac))
...
{ \
    RTI_UINT32 tempAns; \
    tempAns = (((RTI_UINT32) ((time)->sec)) << 16) | ((time)->frac >> 16); \
    tempAns /= divisor; \
    (answer)->sec = ((RTI_INT32) tempAns) >> 16; \
