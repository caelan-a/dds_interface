...
/*
 * @(#)osapi_alignment_impl.h    generated by: makeheader    Fri Apr 23 00:09:51 2021
 *
...
#define RTIOsapiAlignment_alignAddressUpMacro(location, alignment) \
    ((void *)((((RTI_UINT64)(location)) + ((RTI_UINT64) (alignment) - 1)) \
              & ~((RTI_UINT64) (alignment) - 1)))

#define RTIOsapiAlignment_isAligned(location, alignment) \
    ((((RTI_UINT64)(location)) % (RTI_UINT64) (alignment)) == 0)

#else
#define RTIOsapiAlignment_alignAddressUpMacro(location, alignment) \
    ((void *)((((RTI_UINT32)(location)) + ((RTI_UINT32) (alignment) - 1)) \
              & ~((RTI_UINT32) (alignment) - 1)))

#define RTIOsapiAlignment_isAligned(location, alignment) \
    ((((RTI_UINT32)(location)) % (RTI_UINT32) (alignment)) == 0)

#endif

#define RTIOsapiAlignment_alignSizeUpMacro(size, alignment) \
    (((size) + ((RTIOsapiAlignment) (alignment) - 1)) \
            & ~((RTIOsapiAlignment) (alignment) - 1))
...
*/
#define RTIOsapiAlignment_getDefaultAlignment() \
    (RTIOsapiAlignment)offsetof(struct RTIOsapiAlignmentStructContainingUnionOfAllDataTypes, \
             member)
