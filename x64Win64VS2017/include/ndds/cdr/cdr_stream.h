...
/*
 * @(#)cdr_stream.h    generated by: makeheader    Fri Apr 23 00:04:25 2021
 *
...
extern RTICdrDllExport
struct RTICdrStream * RTICdrStream_new(void);
...
extern RTICdrDllExport
void* RTICdrStream_getUserData(struct RTICdrStream *me);

extern RTICdrDllExport
void RTICdrStream_setUserData(struct RTICdrStream *me, void *newUserData);
...
extern RTICdrDllExport
RTIBool RTICdrStream_serializeSequenceNumber(
      struct RTICdrStream *me,
      const struct REDASequenceNumber *sn);

extern RTICdrDllExport
RTIBool RTICdrStream_deserializeSequenceNumber(
      struct RTICdrStream *me,
...
extern RTICdrDllExport
RTIBool RTICdrStream_peekEncapsulationId(
        struct RTICdrStream *me,
        RTIXCdrEncapsulationId *id);

extern RTICdrDllExport
RTIBool RTICdrStream_isCompressionEnabledOnEncapsulation(struct RTICdrStream *me);

extern RTICdrDllExport
void RTICdrStream_setEncapsulationOptionsCompressionId(
        struct RTICdrStream *me,
        RTIOsapiCompressionPluginClassId compressionId);

extern RTICdrDllExport
RTIOsapiCompressionPluginClassId
RTICdrStream_getEncapsulationOptionsCompressionId(
        const struct RTICdrStream *me);

extern RTICdrDllExport
void RTICdrStream_setEncapsulationOptionsNumPaddingBytes(
        struct RTICdrStream *me,
        RTICdrOctet padding);

extern RTICdrDllExport
RTICdrOctet RTICdrStream_getEncapsulationOptionsNumPaddingBytes(
        const struct RTICdrStream *me);

extern RTICdrDllExport
void RTICdrEncapsulationOptions_pack(
        unsigned short *options,
        RTIOsapiCompressionPluginClassId compressionId,
        RTICdrOctet numPaddingBytes);

extern RTICdrDllExport
void RTICdrEncapsulationOptions_unpack(
        const unsigned short options,
        RTIOsapiCompressionPluginClassId *compressionId,
        RTICdrOctet *numPaddingBytes);

extern RTICdrDllExport
RTIBool RTICdrStream_uncompress(
        struct RTICdrStream *me,
        struct REDAThresholdBufferPool *bufferPool,
        struct REDABuffer *uncompressBuffer,
        RTIBool deserializeEncapsulation);
