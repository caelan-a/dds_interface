...
/*
 * @(#)cdr_stream_impl.h    generated by: makeheader    Fri Apr 23 00:04:26 2021
 *
...
struct RTICdrStream {
    ...
    */
    ...
    const void *_context;
    /*i
     * Indicates whether the received encapsulation has compression enabled.
     * This flag will perdure on the stream after being uncompressed to check if
     * the stream has been uncompressed or not.
     */
    RTIBool _isCompressionEnabledOnEncapsulation;
};
...
#define RTICdrStream_initFromStreamMacro(me, srcStream) \
    ...
    (me)->_context = (srcStream)->_context;
...
#define RTICdrStream_setMacro(me, buffer, length) \
    ...
    (me)->_isCompressionEnabledOnEncapsulation = RTI_FALSE

#define RTICdrStream_setContextMacro(me, context) \
    (me)->_context = context;

#ifndef RTI_PRECONDITION_TEST
  #define RTICdrStream_set RTICdrStream_setMacro
  #define RTICdrStream_setContext RTICdrStream_setContextMacro
#endif /* RTI_PRECONDITION_TEST */
...
#define RTICdrStream_getUserDataMacro(me) ((me)->_userData)
#ifndef RTI_PRECONDITION_TEST
  #define RTICdrStream_getUserData RTICdrStream_getUserDataMacro
#endif /* RTI_PRECONDITION_TEST */

#define RTICdrStream_setUserDataMacro(me, newUserData) \
    ((me)->_userData = (newUserData))
#ifndef RTI_PRECONDITION_TEST
  #define RTICdrStream_setUserData RTICdrStream_setUserDataMacro
#endif /* RTI_PRECONDITION_TEST */

#define RTICdrStream_checkSizeMacro(me, size) \
  (((RTICdrUnsignedLong) (size) > (RTICdrUnsignedLong) ((me)->_bufferLength)) \
...
#define RTICdrStream_alignFastMacro(me, align)  \
  ...
  typedef RTI_UINT64 RTICdr8Byte;
  typedef RTI_DOUBLE128 RTICdr16Byte;
...
#define RTICdrStream_skipBitsAndGetLength(me, bitSize)                \
  ...
  #define RTICdrStream_serializeSequenceNumber(me, out) \
  ( \
    ( \
      RTICdrStream_align((me), RTI_CDR_SEQUENCE_NUMBER_ALIGN) && \
          RTICdrStream_checkSize((me), RTI_CDR_SEQUENCE_NUMBER_SIZE) \
    )? \
    ( \
      RTICdrStream_serializeLongFast((me), &(out)->high), \
      RTICdrStream_serializeUnsignedLongFast((me), &(out)->low), \
      RTI_TRUE \
    ): RTI_FALSE \
  )

  #define RTICdrStream_deserializeSequenceNumber(me, out) \
  ( \
    ( \
      RTICdrStream_align((me), RTI_CDR_SEQUENCE_NUMBER_ALIGN) && \
          RTICdrStream_checkSize((me), RTI_CDR_SEQUENCE_NUMBER_SIZE) \
    ...
    ( \
      RTICdrStream_deserializeLongFast((me), &(out)->high), \
      RTICdrStream_deserializeUnsignedLongFast((me), &(out)->low), \
      RTI_TRUE \
    ): RTI_FALSE \
  )
...
#define RTICdrEncapsulationId RTIXCdrEncapsulationId
#define RTICdrEncapsulationOptions RTIXCdrEncapsulationOptions

#define RTICdrStream_setEncapsulationOptionsCompressionId( \
        __me,                                              \
        __compressionId)                                   \
    RTIXCdrStream_setEncapsulationOptionsCompressionId(    \
            RTICdrStream_asXCdrStream(__me),               \
            __compressionId)

#define RTICdrStream_getEncapsulationOptionsCompressionId(__me) \
    RTIXCdrStream_getEncapsulationOptionsCompressionId(         \
            RTICdrStream_asXCdrStream(__me))

#define RTICdrStream_setEncapsulationOptionsNumPaddingBytes(__me, __padding) \
    RTIXCdrStream_setEncapsulationOptionsNumPaddingBytes(                    \
            RTICdrStream_asXCdrStream(__me),                           \
            __padding)

#define RTICdrStream_getEncapsulationOptionsNumPaddingBytes(__me) \
    RTIXCdrStream_getEncapsulationOptionsNumPaddingBytes(         \
            RTICdrStream_asXCdrStream(__me))

#define RTICdrEncapsulationOptions_pack(__opts, __compressionId, __padding) \
    RTIXCdrEncapsulationOptions_pack( \
            __opts, \
            (RTIXCdrOctet)__compressionId, \
            __padding)

#define RTICdrEncapsulationOptions_unpack(__opts, __compressionId, __padding) \
    RTIXCdrEncapsulationOptions_unpack(__opts, __compressionId, __padding)



#define RTICdrStream_isCompressionEnabledOnEncapsulation(__sampleStream) \
    (__sampleStream)->_isCompressionEnabledOnEncapsulation
