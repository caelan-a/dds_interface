...
/*
 * @(#)cdr_type_impl.h    generated by: makeheader    Fri Apr 23 00:04:26 2021
 *
...
#define RTICdrType_printNativeLongLongMacro(value, desc, indent)      \
   ...
   (((void *) (value) == NULL) ?                                               \
    (((void *) (desc) != NULL) ? RTILogParamString_printPlain("%s: NULL\n", (desc)) :         \
      RTILogParamString_printPlain("NULL\n")) :                                      \
    (((void *) (desc) != NULL) ?                                               \
      RTILogParamString_printPlain("%s: %lld\n", (desc), *(value)) :                 \
      RTILogParamString_printPlain("%lld\n", *(value))))
...
#define RTICdrType_printNativeUnsignedLongLongMacro(value, desc, indent) \
   ...
   (((void *) (value) == NULL) ?                                               \
    (((void *) (desc) != NULL) ? RTILogParamString_printPlain("%s: NULL\n", (desc)) :         \
      RTILogParamString_printPlain("NULL\n")) :                                      \
    (((void *) (desc) != NULL) ?                                               \
      RTILogParamString_printPlain("%s: %llu\n", (desc), *(value)) :                 \
      RTILogParamString_printPlain("%llu\n", *(value))))
...
#define RTICdrType_printNativeLongDoubleMacro(value, desc, indent)     \
   ...
   (((void *) (value) == NULL) ?                                                \
    (((void *) (desc) != NULL) ? RTILogParamString_printPlain("%s: NULL\n", (desc)) :          \
      RTILogParamString_printPlain("NULL\n")) :                                       \
    (((void *) (desc) != NULL) ? RTILogParamString_printPlain("%s: %Lf\n", (desc), *(value)) : \
      RTILogParamString_printPlain("%Lf\n", *(value))))
...
#define RTICdrType_printNotImplMacro(value, desc, indent)             \
   ...
   (((void *) (value) == NULL) ?                                               \
    (((void *) (desc) != NULL) ? RTILogParamString_printPlain("%s: NULL\n", (desc)) :          \
      RTILogParamString_printPlain("NULL\n")) :                                       \
    (((void *) (desc) != NULL) ?                                               \
      RTILogParamString_printPlain("%s: not implemented\n", (desc)) :                 \
      RTILogParamString_printPlain("not implemented\n")))
