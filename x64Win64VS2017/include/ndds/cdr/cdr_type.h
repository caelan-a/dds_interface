...
/*
 * @(#)cdr_type.h    generated by: makeheader    Fri Apr 23 00:04:26 2021
 *
 *		built from:	type.ifc
 */
...
#define RTI_CDR_SEQUENCE_NUMBER_SIZE 8
...
*/
#define RTI_CDR_SEQUENCE_NUMBER_ALIGN 4
/*e \ingroup RTICdrTypeAlignModule 
...
extern RTICdrDllExport
void RTICdrType_printUInt8(const RTICdrOctet *value, const char *desc,
			     int indent);

extern RTICdrDllExport
void RTICdrType_printInt8(const RTICdrInt8 *value, const char *desc,
			     int indent);
