...
/*
 * @(#)cdr_typeObject.h    generated by: makeheader    Fri Apr 23 00:04:26 2021
 *
...
typedef struct RTICdrTypeObjectFactory {
    ...
    /*i @brief (private) Fast buffer pool to allocate TypeObjects in buffer
      ...
      */
    struct REDAFastBufferPool * _deserializePool;
    
    /*i @brief (private) Fast buffer pool to allocate serialize buffers when.
     * size is below serializedAllocThreshold.
     *
     * Used to generate the buffers returned by
     * RTICdrTypeObjectFactory_getSerializationBuffer.
     */
...
extern RTICdrDllExport
void *RTICdrTypeObjectFactory_getDeserializationBuffer(
    struct RTICdrTypeObjectFactory *self,
    int deserializedSize);

extern RTICdrDllExport
void RTICdrTypeObjectFactory_returnDeserializationBuffer(
    struct RTICdrTypeObjectFactory *self,
    void *buffer,
    int bufferSize);
