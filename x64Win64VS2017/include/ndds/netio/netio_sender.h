...
/*
 * @(#)netio_sender.h    generated by: makeheader    Fri Apr 23 00:09:51 2021
 *
...
struct RTINetioSenderProperty {
    ...
    */
    ...
    /*e
     * Print warning message when RTINetioSender_send operation time exceeds
     * sendTimeBasedLoggingThreshold.
     * Default: INFINITE
     */
    RTINtpTime sendTimeBasedLoggingThreshold;
};
...
#define RTI_NETIO_SENDER_PROPERTY_DEFAULT {  \
    ...
    {RTI_NTP_TIME_SEC_MAX, RTI_NTP_TIME_FRAC_AUTO} \
}
...
extern RTINetioDllExport RTIBool RTINetioSenderDestinationGroup_sendFast(
        ...
        const struct RTINetioCapArguments *netioCapArguments,
        struct REDAWorker *worker);
...
typedef enum {
    RTI_NETIO_SENDER_COMBINE_DESTINATIONS_RETCODE_OK_EQUIVALENT,
    RTI_NETIO_SENDER_COMBINE_DESTINATIONS_RETCODE_OK_DIFFERENT,
    RTI_NETIO_SENDER_COMBINE_DESTINATIONS_RETCODE_ERROR
} RTINetioSenderCombineDestinationsRetcode;

extern RTINetioDllExport
RTINetioSenderCombineDestinationsRetcode
RTINetioSender_checkAndCombineEquivalentDestinations(
        struct RTINetioSender *me,
        const struct RTINetioLocatorInfo *existingDestination,
        const struct RTINetioLocator *newDestination,
        RTIBool combineDestinations,
        struct REDAWorker *worker);
...
extern RTINetioDllExport 
struct RTINetioSender *RTINetioSender_new(
