...
/*
 * @(#)netio_sender_impl.h    generated by: makeheader    Fri Apr 23 00:09:51 2021
 *
...
extern RTINetioDllExport RTIBool RTINetioSender_send(
        ...
        const struct REDAWeakReference *toArray,
        int toArraySize,
...
/* --------------------------------------------------------------- */
#define RTINetioSenderDestinationGroup_sendFast( \
        me, \
        buffer, \
        bufferCount, \
        priority, \
...
/* --------------------------------------------------------------- */
#define RTINetioSender_sendFast( \
        me, \
        toArray, \
        toArraySize, \
        buffer, \
