...
/*
 * @(#)netio_configurator.h    generated by: makeheader    Fri Apr 23 00:09:50 2021
 *
...
extern RTINetioDllExport
struct RTINetioConfigurator* RTINetioConfigurator_newWithConcurrency(
    const struct RTINetioConfiguratorProperty *propertyIn,
    struct REDADatabase *databaseIn,
    const struct RTINetioConcurrency *concurrency,
    struct RTIEventActiveObjectListener *shutdownListenerIn,
    struct REDAWorker *worker);
...
extern RTINetioDllExport
RTIBool RTINetioConfigurator_isUdpv4Transport(
        struct RTINetioConfigurator *me,
        NDDS_Transport_ClassId_t classId);

extern RTINetioDllExport
RTIBool RTINetioConfigurator_isUdpv4WanTransport(
        struct RTINetioConfigurator *me,
        NDDS_Transport_ClassId_t classId);
...
extern RTINetioDllExport 
RTIBool RTINetioConfigurator_areLocatorsEquivalent(
        struct RTINetioConfigurator *me,
        const struct RTINetioLocator *firstLocator,
        const struct RTINetioLocator *secondLocator,
        struct REDAWorker *worker);
...
struct RTINetioConfiguratorPopulatedLocatorsProperty {
    /*e @brief Defines whether the populated locators must be allowed by
     * the entryport routing table or not.
     */
    RTIBool mustBeAllowedByEntryportRoutingTable;
    /*e @brief Defines whether the populated locators must be allowed by
     * the destination routing table or not.
     */
    RTIBool mustBeAllowedByDestinationRoutingTable;
    /*e @brief Defines whether the populated locators must be in the multicast
     * address range or not.
     */
    RTIBool mustBeMulticast;
    /*e @brief Defines whether the hostname of the populated locators
     * must be copied or not.
     */
    RTIBool copyHostname;
};


#define RTI_NETIO_CONFIGURATOR_POPULATED_LOCATORS_PROPERTY_DEFAULT {     \
        RTI_FALSE, /* mustBeAllowedByEntryportRoutingTable */ \
        RTI_FALSE, /* mustBeAllowedByDestinationRoutingTable */ \
        RTI_FALSE, /* mustBeMulticast */ \
        RTI_FALSE /* address copyHostname */ \
}
...
RTINetioConfigurator_populateLocators(
    ...
    const struct RTINetioAliasList *enabledPluginAliasesIn,
    const struct RTINetioConfiguratorPopulatedLocatorsProperty *locatorPropertyIn,
    struct REDAWorker *worker);
...
extern RTINetioDllExport
RTIBool RTINetioConfigurator_getTransportClassIdListFromString(
        struct RTINetioConfigurator *self,
        struct NDDS_Transport_ClassId_List *classIdList,
        const char *aliasString,
        struct REDAWorker *worker);

extern RTINetioDllExport
RTIBool RTINetioConfigurator_getTransportClassIdListFromAliasList(
        struct RTINetioConfigurator *self,
        struct NDDS_Transport_ClassId_List *classIdList,
...
extern RTINetioDllExport
NDDS_Transport_Plugin * RTINetioConfiguratorUtil_setupUDPv4WanPlugin(
        struct REDAWeakReference *pluginHandleOut,
        struct RTINetioConfigurator *configuratorIn,
        struct RTIClock *clockIn,
        struct NDDS_Transport_UDPv4_SocketFactory *socketFactoryIn,
        struct RTINetioAliasList *aliasListIn,
        struct NDDS_Transport_UDPv4_WAN_Property_t *propertyIn,
        struct REDAWorker *worker);
