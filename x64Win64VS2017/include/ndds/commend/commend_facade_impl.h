...
/*
 * @(#)commend_facade_impl.h    generated by: makeheader    Fri Apr 23 00:04:34 2021
 *
...
#define COMMENDFacade_removeTokenBucket(me, tokenBucket) \
    RTIEventJobDispatcher_removeTokenBucket((me)->_jobDispatcher, tokenBucket)
...
#define COMMENDFacade_assertTokenBucketRR(me, property) \
    RTIEventJobDispatcher_assertTokenBucket((me)->_jobDispatcher, \
        ...
        NULL /*priorityCopyFnc*/, NULL /*bucketStorage*/, property)

/* agentCompareFnc = NULL b/c unique agents are checked at the 'assert remote reader' level */
/* bucketStorage = NULL b/c unique buckets are checked at PRES 'create flow controller' level */
#define COMMENDFacade_assertTokenBucketEDF(me, property) \
    RTIEventJobDispatcher_assertTokenBucket((me)->_jobDispatcher, \
        ...
        NULL /*bucketStorage*/, property)

/* agentCompareFnc = NULL b/c unique agents are checked at the 'assert remote reader' level */
/* bucketStorage = NULL b/c unique buckets are checked at PRES 'create flow controller' level */
#define COMMENDFacade_assertTokenBucketHPF(me, property) \
    RTIEventJobDispatcher_assertTokenBucket((me)->_jobDispatcher, \
        NULL /*agentCompareFnc*/, \
...
#define COMMENDFacade_getTokenBucketProperty(me, tokenBucket, property) \
    RTIEventJobDispatcher_getTokenBucketProperty((me)->_jobDispatcher, tokenBucket, property)

#define COMMENDFacade_setTokenBucketProperty(me, tokenBucket, property) \
    RTIEventJobDispatcher_setTokenBucketProperty((me)->_jobDispatcher, tokenBucket, property)

#define COMMENDFacade_addTokensToBucket(me, tokenBucket) \
    RTIEventJobDispatcher_addTokens((me)->_jobDispatcher, tokenBucket)

#define COMMENDFacade_assertThread(me, threadStorage, eaBeforeAgentFncs, property) \
    RTIEventJobDispatcher_assertThread((me)->_jobDispatcher, threadStorage, eaBeforeAgentFncs, property)

#define COMMENDFacade_removeThread(me, executionThread) \
    RTIEventJobDispatcher_removeThread((me)->_jobDispatcher, executionThread)

#define COMMENDFacade_detachJobDispatcherThread(me, executionThread) \
    RTIEventJobDispatcher_detachThread((me)->_jobDispatcher, executionThread)
