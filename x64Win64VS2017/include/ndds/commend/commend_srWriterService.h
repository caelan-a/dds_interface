...
/*
 * @(#)commend_srWriterService.h    generated by: makeheader    Fri Apr 23 00:04:40 2021
 *
 ...
 * See CORE-7133 */
#define COMMEND_WRITER_HB_EPOCH PROPERTY_NAME_DDS_DATA_WRITER_INITIAL_HB_EPOCH
...
struct COMMENDSrWriterServiceWriterProperty {
    ...
    */
    ...
    /*e
     * Set to true for Durable DataWriter when DurabilityQoS::writer_depth is
     * smaller than HistoryDepth
     */
    RTIBool supportsDurableWriterDepth;
};
  ...
  #define COMMEND_SR_WRITER_SERVICE_WRITER_PROPERTY_DEFAULT { \
    ...
    0, /* initialHBEpoch */ \
    RTI_FALSE /* supportsDurableWriterDepth */ \
}
