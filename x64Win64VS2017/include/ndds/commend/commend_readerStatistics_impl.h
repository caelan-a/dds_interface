...
/*
 * @(#)commend_readerStatistics_impl.h    generated by: makeheader    Fri Apr 23 00:04:35 2021
 *
...
#define COMMENDReaderService_addLocalReaderStatistics(sum, in1, in2) { \
        ...
        (sum)->outOfRangeRejectedSampleCount = (in1)->outOfRangeRejectedSampleCount + (in2)->outOfRangeRejectedSampleCount; \
        (sum)->fragmentsReceivedCount = (in1)->fragmentsReceivedCount + (in2)->fragmentsReceivedCount; \
        (sum)->fragmentsDroppedCount = (in1)->fragmentsDroppedCount + (in2)->fragmentsDroppedCount; \
        (sum)->samplesReassembledCount = (in1)->samplesReassembledCount + (in2)->samplesReassembledCount; \
        (sum)->nackFragmentsSentCount = (in1)->nackFragmentsSentCount + (in2)->nackFragmentsSentCount; \
        (sum)->nackFragmentsSentBytes = (in1)->nackFragmentsSentBytes + (in2)->nackFragmentsSentBytes; \
}
