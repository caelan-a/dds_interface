...
/*
 * @(#)ndds_config_cpp.h    generated by: makeheader    Fri Apr 23 00:38:54 2021
 *
...
class DDSCPPDllExport NDDSConfigLogger {
  public:
    ...
    /*e \dref_Logger_get_print_format_by_log_level
     */
    NDDS_Config_LogPrintFormat get_print_format_by_log_level(
            NDDS_Config_LogLevel log_level);

    /*e \dref_Logger_set_print_format_by_log_level
     */
    bool set_print_format_by_log_level(
...
class DDSCPPDllExport NDDSConfigActivityContext {
  public:
    /*e \dref_ActivityContext_set_attribute_mask */
    static void set_attribute_mask(
            NDDS_Config_ActivityContextAttributeKindMask attribute_format);
};
