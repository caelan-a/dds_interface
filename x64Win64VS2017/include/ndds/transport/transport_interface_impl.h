...
/*
 * @(#)transport_interface_impl.h    generated by: makeheader    Fri Apr 23 00:11:22 2021
 *
...
#define NDDS_Transport_Plugin_initialize( \
     ...
     get_transport_receive_context_in, \
     get_transport_send_context_in, \
    ...
    (self)->get_transport_receive_context = get_transport_receive_context_in; \
    (self)->get_transport_send_context = get_transport_send_context_in; \
    (self)->are_addresses_equivalent = NULL; \
    (self)->is_valid_entry_port = NULL; \
    (self)->update_destination = NULL; \
