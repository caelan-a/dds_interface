...
/*
 * @(#)transport_log.h    generated by: makeheader    Fri Apr 23 00:11:22 2021
 *
 *		built from:	log.ifc
 */
...
/*e \ingroup NDDS_TransportLogMessageClass
  \brief UDPv4 Transport Plugin submodule identifier. For use in log message numbers.
  @see RTILogNumberBitmapClass
 */
...
/*e \ingroup NDDS_TransportLogMessageClass
  ...
  @see RTILogNumberBitmapClass
 */
  #define SUBMODULE_TRANSPORT_PLUGIN_META      (0x0005)

/*e \ingroup NDDS_TransportLogMessageClass
  \brief UDPv6 Transport Plugin submodule identifier. For use in log message numbers.
  @see RTILogNumberBitmapClass
 */
  #define SUBMODULE_TRANSPORT_PLUGIN_UDPV6     (0x0006)

/*e \ingroup NDDS_TransportLogMessageClass
  \brief UDP Transport Plugin submodule identifier. For use in log message numbers.
  @see RTILogNumberBitmapClass
 */
  #define SUBMODULE_TRANSPORT_PLUGIN_UDP    (0x0007)
  ...
  #define NDDS_TRANSPORT_SUBMODULE_MASK_UDP   (0x0010)
  ...
  #define NDDS_TRANSPORT_SUBMODULE_MASK_UDPV4   (0x0200)
