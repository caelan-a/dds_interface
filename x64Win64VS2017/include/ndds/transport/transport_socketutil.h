...
/*
 * @(#)transport_socketutil.h    generated by: makeheader    Fri Apr 23 00:11:23 2021
 *
...
/*i \ingroup NDDS_TransportSocketUtilComponent
 *
 * @brief Converts a sockaddr into a transport port for IPv4 and IPv6
 *
 *  @param transportPort \b out. Output transport port.
 *
 *  @param address \b in. Input sockaddr address.
 *
 *  @param family \b in. Socket family: RTI_OSAPI_SOCKET_AF_INET or
 *  RTI_OSAPI_SOCKET_AF_INET6.
 */
extern NDDS_Transport_DllExport
void NDDS_Transport_SocketUtil_Address_to_transportPort(
        NDDS_Transport_Port_t *transportPort,
        const struct sockaddr *address,
        RTIOsapiSocketAFKind family);

extern NDDS_Transport_DllExport
NDDS_Transport_Port_t NDDS_Transport_SocketUtil_socket_to_port(
        RTI_INT32 socket_in);
