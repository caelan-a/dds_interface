...
/*
 * @(#)transport_shmem.h    generated by: makeheader    Fri Apr 23 00:11:23 2021
 *
...
struct NDDS_Transport_Shmem_Property_t {
    ...
    */
     ...
     * If a writer takes longer, it can be potentially be aborted writing by a
     * reader believing the writer is stuck (i.e. in an infinite loop).
    ...
    /*i
     * Major version of the shared memory protocol.
     * Different major versions are incompatible.
     */
    RTI_INT16 majorVersion;
};
...
#define NDDS_TRANSPORT_SHMEM_MAJOR_BEFORE_BUG_14240_FIX (1)


#define NDDS_TRANSPORT_SHMEM_MAJOR_AFTER_BUG_14240_FIX (2)


#define NDDS_TRANSPORT_SHMEM_MAJOR_AFTER_WRITER_COOKIE_SUPPORT (4)
...
#define NDDS_TRANSPORT_SHMEM_PROPERTY_DEFAULT { \
    ...
    RTI_FALSE, /* reserved */ \
    NDDS_TRANSPORT_ADDRESS_INVALID_INITIALIZER, /* shmemUUID */ \
    NDDS_TRANSPORT_SHMEM_MAJOR_AFTER_BUG_14240_FIX /* majorVersion */ \
 }
