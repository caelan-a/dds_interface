...
/*
 * @(#)transport_udpv4.h    generated by: makeheader    Fri Apr 23 00:11:23 2021
 *
...
#define NDDS_Transport_UDPv4_WAN_Property_t NDDS_Transport_UDP_Property_t


#define NDDS_TRANSPORT_UDPV4_CLASS_NAME		"udpv4"


#define NDDS_TRANSPORT_UDPV4_WAN_CLASS_NAME		"udpv4_wan"


#define NDDS_TRANSPORT_BUILTIN_UDPV4_ALIAS      "builtin.udpv4"


#define NDDS_TRANSPORT_BUILTIN_UDPV4_WAN_ALIAS      "builtin.udpv4_wan"
...
#define NDDS_TRANSPORT_UDPV4_PROPERTY_DEFAULT { \
    ...
    1, /* unicast_enabled */ \
    NDDS_TRANSPORT_UDPV4_USE_MULTICAST_DEFAULT, /* multicast_enabled */ \
...
/*e \ingroup NDDS_Transport_UDPv4_WAN_Plugin
 * \brief Use this to initialize a NDDS_Transport_UDPv4_WAN_Property_t structure.
 */
...
extern NDDS_Transport_DllExport
NDDS_Transport_Plugin * NDDS_Transport_UDPv4_WAN_newI(
        const struct NDDS_Transport_UDPv4_WAN_Property_t *property_in,
        struct NDDS_Transport_UDPv4_SocketFactory *socket_factory_in,
        struct NDDS_Transport_UDPv4_InterfaceListener *interface_listener_in,
        struct RTIClock *clock_in);
...
extern NDDS_Transport_DllExport
RTI_INT32 NDDS_Transport_UDPv4_WAN_Address_to_string(
        const NDDS_Transport_Address_t *me,
        char *buffer,
        int buffer_length_in);

extern NDDS_Transport_DllExport
void NDDS_Transport_UDPv4_WAN_Address_print(
        const NDDS_Transport_Address_t *me,
        const char *desc,
        RTI_INT32 indent);
