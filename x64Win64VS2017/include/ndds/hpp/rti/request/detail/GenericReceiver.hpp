        ...
        try {
            dds::topic::ContentFilteredTopic<T> cft =
                    dds::core::polymorphic_cast<
                            dds::topic::ContentFilteredTopic<T> >(topic_desc);
            reader_ = dds::sub::DataReader<T>(subscriber, cft, qos, listener, mask);
        } catch (const dds::core::InvalidDowncastError&) {
            dds::topic::Topic<T> topic =
                    dds::core::polymorphic_cast<dds::topic::Topic<T> >(
                            topic_desc);
            reader_ = dds::sub::DataReader<T>(subscriber, topic, qos, listener, mask);
        }
