...
/**
 * \dref_LoggingGroupDocs
 */

namespace rti { 

/**
 * @brief @extension Logging configuration and version information.
 */
namespace config {

/**
 * @ingroup DDSLoggingModule
 * @headerfile rti/config/Logger.hpp
 * @brief The definition of the dds::core::safe_enum LogLevel;
 */
struct LogLevel_def {

    typedef NDDS_Config_LogLevel native_type;

    /**
     * @brief The underlying \p enum type
     */
    enum type {
        /** \dref_LogLevel_NDDS_CONFIG_LOG_LEVEL_FATAL_ERROR */
        FATAL_ERROR = NDDS_CONFIG_LOG_LEVEL_FATAL_ERROR,

        /** \dref_LogLevel_NDDS_CONFIG_LOG_LEVEL_ERROR */
        EXCEPTION = NDDS_CONFIG_LOG_LEVEL_ERROR,

        /** \dref_LogLevel_NDDS_CONFIG_LOG_LEVEL_WARNING */
        WARNING = NDDS_CONFIG_LOG_LEVEL_WARNING,

        /** \dref_LogLevel_NDDS_CONFIG_LOG_LEVEL_STATUS_LOCAL */
        STATUS_LOCAL = NDDS_CONFIG_LOG_LEVEL_STATUS_LOCAL,

        /** \dref_LogLevel_NDDS_CONFIG_LOG_LEVEL_STATUS_REMOTE */
        STATUS_REMOTE = NDDS_CONFIG_LOG_LEVEL_STATUS_REMOTE,

        /** \dref_LogLevel_NDDS_CONFIG_LOG_LEVEL_DEBUG */
        STATUS_ALL = NDDS_CONFIG_LOG_LEVEL_DEBUG
    };
};

/**
 * @ingroup DDSLoggingModule
 * @brief The log level at which \ndds diagnostic information is logged.
 *
 * @see LogLevel_def
 */
...
struct Verbosity_def {
    ...
    enum type {
        ...
        EXCEPTION = RTI_LOG_BIT_EXCEPTION | RTI_LOG_BIT_FATAL_ERROR,
...
struct PrintFormat_def {
    ...
    enum type {
        ...
        /*i \dref_LogPrintFormat_NDDS_CONFIG_LOG_PRINT_BIT_ACTIVITY_CONTEXT
         */
        BIT_ACTIVITY_CONTEXT = NDDS_CONFIG_LOG_PRINT_BIT_ACTIVITY_CONTEXT,

        /*i \dref_LogPrintFormat_NDDS_CONFIG_LOG_PRINT_BIT_TWO_LINES
         */
        BIT_TWO_LINES = NDDS_CONFIG_LOG_PRINT_BIT_TWO_LINES,

        /*i \dref_LogPrintFormat_NDDS_CONFIG_LOG_PRINT_BIT_BACKTRACE
         */
        BIT_BACKTRACE = NDDS_CONFIG_LOG_PRINT_BIT_BACKTRACE,
...
class OMG_DDS_API Logger {
  public:
    ...
    /** \dref_Logger_get_print_format_by_log_level
     */
    PrintFormat print_format_by_log_level(LogLevel log_level);

    /** \dref_Logger_set_print_format_by_log_level
     */
