 ...
 *
 * @see dds::core::xtypes::DynamicData::member_info()
 */
...
public:
    ...
    /**
     * @brief The type kind of this member
     *
     * This a convenience function, equivalent to looking up the member's
     * DynamicType::kind().
     *
     * @see dds::core::xtypes::DynamicData::type()
     * @see dds::core::xtypes::DynamicType::kind()
     */
    ...
    /**
     * @brief If this member is a collection, this function returns the type kind
     * of its elements.
     *
     * This function provides the same information as
     * dds::core::xtypes::CollectionType::content_type().
     *
     * @see dds::core::xtypes::DynamicData::type()
     * @see dds::core::xtypes::CollectionType::content_type()
     */
    dds::core::xtypes::TypeKind element_kind() const;

    /**
     * @brief Indicates if this member is present in this sample
     *
     * @details \dref_details_DynamicDataMemberInfo_member_exists
     */
