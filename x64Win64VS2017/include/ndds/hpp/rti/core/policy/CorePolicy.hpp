...
typedef detail::DurabilityService DurabilityService;
typedef detail::Presentation Presentation;
...
typedef detail::DataRepresentation DataRepresentation;
...
public:
    ...
    typedef dds::core::policy::DataRepresentation WrapperType;
    ...
    /**
     * @memberof dds::core::policy::DataRepresentation
     *
     * @brief @extension Gets the compression settings by const reference (see
     * setter).
     *
     ...
     * @memberof dds::core::policy::DataRepresentation
     *
     * @brief @extension Gets the compression settings by non-const reference
     * (see setter)
     *
     * @extension_member_note
     */
     ...
     * @memberof dds::core::policy::DataRepresentation
     *
     * @brief @extension Sets the compression settings.
     *
     * @extension_member_note
     *
     * @details \dref_details_DataRepresentationQosPolicy_compression_settings
     */
...
public:
     ...
     * @memberof dds::core::policy::Durability
     *
     * @brief @extension Indicates the number of samples a durable DataWriter
     * will send to a late joining DataReader.
     *
     * @extension_member_note
     *
     * @details \dref_details_DurabilityQosPolicy_writer_depth
     */
...
public:
  ...
  public:
    ...
    typedef dds::core::policy::Presentation WrapperType;
  ...
  public:
    ...
    /**
     * @memberof dds::core::policy::Presentation
     *
     * @brief @extension Indicates whether or not a DataReader should drop
     * samples from an incomplete coherent set for which not all 
     * the relevant samples where received.
     * 
     * @details \dref_details_PresentationQosPolicy_drop_incomplete_coherent_set
     */
...
public:
     ...
     * @extension_member_note
     *
     * @details \dref_details_ReaderDataLifecycleQosPolicy_autopurge_nowriter_instances_delay
     */
...
public:
     ...
     * @brief @extension Sets the number of samples that a DataReader or
    ...
    /**
     * @memberof dds::core::policy::ResourceLimits
     * @brief @extension Sets the number of instances that a DataReader or
     * a DataWriter will preallocate.
     *
     * @extension_member_note
     *
    ...
    /**
     * @memberof dds::core::policy::ResourceLimits
     * @brief @extension Sets the number of hash buckets for looking up
     * instances
     *
     * @extension_member_note
     *
...
public:
    ...
    typedef dds::core::policy::DurabilityService WrapperType;
...
/** 
 * @brief @extension The default value for
 *        \idref_DurabilityQosPolicy_writer_depth
 *
 * @namespace_note rti::core::policy
 *
 * @details \dref_details_AUTO_WRITER_DEPTH
 */
inline int32_t auto_writer_depth() 
{
    return DDS_AUTO_WRITER_DEPTH;
}
...
public:
    ...
    /** \dref_DomainParticipantResourceLimitsQosPolicy_serialized_type_object_dynamic_allocation_threshold
     */
    DomainParticipantResourceLimits& 
...
public:
    ...
    /**
     * @brief Alias name for the UDPv4 built-in transport: "builtin.udpv4"
     */
    static const std::string UDPv4_ALIAS; 

    /**
     * @brief Alias name for the UDPv4 asymmetric built-in transport:
     * "builtin.udpv4_wan"
     */
    static const std::string UDPv4_WAN_ALIAS; 

    /**
     * @brief Alias name for the UDPv6 built-in transport: "builtin.udpv6"
     */
    ...
    /**
     * @brief Creates a policy that selects TransportBuiltinMask::udpv4_wan()
     */
    static TransportBuiltin UDPv4_WAN()
    {
        return TransportBuiltin(
            rti::core::policy::TransportBuiltinMask::udpv4_wan());
    }
 ...
 *
 * @details \dref_details_PublishModeQosPolicy
 */
...
public:
    ...
    /**
     * @brief Sets the flow controller name associated with a DataWriter
     *
...
public:
    ...
    /** \dref_DataReaderResourceLimitsQosPolicy_instance_replacement */
...
public:
    ...
    /**
     * \dref_RtpsReliableWriterProtocol_t_disable_repair_piggyback_heartbeat
     */
...
public:
    ...
    /**
     * \dref_DiscoveryConfigQosPolicy_secure_volatile_writer
     */
    ...
    /**
     * \dref_DiscoveryConfigQosPolicy_secure_volatile_reader
     */
    ...
    /**
     * \dref_DiscoveryConfigQosPolicy_dns_tracker_polling_period
     */
