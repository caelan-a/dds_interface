 ...
 */
class TransportBuiltinMask : public std::bitset<8> {
public:
    /**
    ...
    /**
     * @brief Selects the built-in UDPv4 asymmetric transport
     */
    static const TransportBuiltinMask udpv4_wan()
    {
        return TransportBuiltinMask(DDS_TRANSPORTBUILTIN_UDPv4_WAN);
    }
...
/**
 * \dref_DataReaderInstanceRemovalKind
 */
struct DataReaderInstanceRemovalKind_def {
    /**
     * @brief The underlying \p enum type
     */
    enum type {
        /** \dref_DataReaderInstanceRemovalKind_NO_INSTANCE_REMOVAL
         */
        NO_INSTANCE,
        /** \dref_DataReaderInstanceRemovalKind_EMPTY_INSTANCE_REMOVAL
         */
        EMPTY_INSTANCES,
        /** \dref_DataReaderInstanceRemovalKind_FULLY_PROCESSED_INSTANCE_REMOVAL
         */
        FULLY_PROCESSED_INSTANCES,
        /** \dref_DataReaderInstanceRemovalKind_ANY_INSTANCE_REMOVAL
         */
        ANY_INSTANCE
    };
};
 ...
 * @brief @extension \ref SafeEnumModule of DataReaderInstanceRemovalKind_def
 * @see \ref DataReaderInstanceRemovalKind_def
 */
typedef dds::core::safe_enum<DataReaderInstanceRemovalKind_def> DataReaderInstanceRemovalKind;
