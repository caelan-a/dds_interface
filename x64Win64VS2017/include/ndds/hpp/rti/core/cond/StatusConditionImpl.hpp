...
public:
    typedef dds::core::smart_ptr_traits<StatusCondition>::ref_type ref_type;
    typedef dds::core::smart_ptr_traits<StatusCondition>::weak_ref_type
            weak_ref_type;
