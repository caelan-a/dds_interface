...
public:
    ...
    AsyncWaitSetProperty(const DDS_AsyncWaitSetProperty_t& native_wsr_property)
...
/**
 * @ingroup DDSAsyncWaitSetModule
 * @brief Implementation of the completion token role element of the
 * asynchronous completion token pattern that is part of the AsyncWaitSet
 * behavior.
 *
 * @details \dref_details_AsyncWaitSetCompletionToken
 */
 ...
 * @headerfile rti/core/cond/AsyncWaitSet.hpp
 *
 * @brief @extension @st_exp Dispatches dds::core::cond::Condition objects using
 * separate threads of execution. Unlike a normal dds::core::cond::WaitSet,
 * which operates on the current thread, an AsyncWaitSet uses a thread pool.
 *
 * @details \dref_details_AsyncWaitSet
 */
...
public:
    static const AsyncWaitSetProperty& property_default()
    {
        static const AsyncWaitSetProperty g_default_value;
