...
public:
    ...
    /** \dref_SampleLostStatusKind_LOST_BY_UNKNOWN_INSTANCE */
    static const SampleLostState lost_by_unknown_instance()
    {
        return SampleLostState(DDS_LOST_BY_UNKNOWN_INSTANCE);
    }

    /** \dref_SampleLostStatusKind_LOST_BY_DESERIALIZATION_FAILURE */
    static const SampleLostState lost_by_deserialization_failure()
    {
        return SampleLostState(DDS_LOST_BY_DESERIALIZATION_FAILURE);
    }

    /** \dref_SampleLostStatusKind_LOST_BY_DECODE_FAILURE */
    static const SampleLostState lost_by_decode_failure()
    {
        return SampleLostState(DDS_LOST_BY_DECODE_FAILURE);
    }

    /** \dref_SampleLostStatusKind_LOST_BY_SAMPLES_PER_INSTANCE_LIMIT */
    static const SampleLostState lost_by_samples_per_instance_limit()
    {
        return SampleLostState(DDS_LOST_BY_SAMPLES_PER_INSTANCE_LIMIT);
    }

    /** \dref_SampleLostStatusKind_LOST_BY_SAMPLES_LIMIT */
    static const SampleLostState lost_by_samples_limit()
    {
        return SampleLostState(DDS_LOST_BY_SAMPLES_LIMIT);
    }
...
/**
 * @relatesalso EventCount
 * @brief @extension Prints an rti::core::status::EventCount to an output stream.
 */
template <typename IntegerType>
...
{
    char change_char = event_count.change() < 0 ? '-' : '+';

    out << "(" << event_count.total() <<  ", " << change_char << event_count.change() << ")";
    return out;
}
...
public:
    ...
    /** \dref_DataReaderCacheStatus_old_source_timestamp_dropped_sample_count */
    int64_t old_source_timestamp_dropped_sample_count() const
    {
        return native().old_source_timestamp_dropped_sample_count;
    }

    /** \dref_DataReaderCacheStatus_tolerance_source_timestamp_dropped_sample_count */
    int64_t tolerance_source_timestamp_dropped_sample_count() const
    {
        return native().tolerance_source_timestamp_dropped_sample_count;
    }

    /** \dref_DataReaderCacheStatus_ownership_dropped_sample_count */
    int64_t ownership_dropped_sample_count() const
    {
        return native().ownership_dropped_sample_count;
    }

    /** \dref_DataReaderCacheStatus_content_filter_dropped_sample_count */
    int64_t content_filter_dropped_sample_count() const
    {
        return native().content_filter_dropped_sample_count;
    }

    /** \dref_DataReaderCacheStatus_time_based_filter_dropped_sample_count */
    int64_t time_based_filter_dropped_sample_count() const
    {
        return native().time_based_filter_dropped_sample_count;
    }

    /** \dref_DataReaderCacheStatus_expired_dropped_sample_count */
    int64_t expired_dropped_sample_count() const
    {
        return native().expired_dropped_sample_count;
    }

    /** \dref_DataReaderCacheStatus_virtual_duplicate_dropped_sample_count */
    int64_t virtual_duplicate_dropped_sample_count() const
    {
        return native().virtual_duplicate_dropped_sample_count;
    }

    /** \dref_DataReaderCacheStatus_replaced_dropped_sample_count */
    int64_t replaced_dropped_sample_count() const
    {
        return native().replaced_dropped_sample_count;
    }

    /** \dref_DataReaderCacheStatus_writer_removed_batch_sample_dropped_sample_count */
    int64_t writer_removed_batch_sample_dropped_sample_count() const
    {
        return native().writer_removed_batch_sample_dropped_sample_count;
    }

    /** \dref_DataReaderCacheStatus_total_samples_dropped_by_instance_replacement */
    int64_t total_samples_dropped_by_instance_replacement() const
    {
        return native().total_samples_dropped_by_instance_replacement;
    }

    /** \dref_DataReaderCacheStatus_alive_instance_count */
    int64_t alive_instance_count() const
    {
        return native().alive_instance_count;
    }

    /** \dref_DataReaderCacheStatus_alive_instance_count_peak */
    int64_t alive_instance_count_peak() const
    {
        return native().alive_instance_count_peak;
    }

    /** \dref_DataReaderCacheStatus_no_writers_instance_count */
    int64_t no_writers_instance_count() const
    {
        return native().no_writers_instance_count;
    }

    /** \dref_DataReaderCacheStatus_no_writers_instance_count_peak */
    int64_t no_writers_instance_count_peak() const
    {
        return native().no_writers_instance_count_peak;
    }

    /** \dref_DataReaderCacheStatus_disposed_instance_count */
    int64_t disposed_instance_count() const
    {
        return native().disposed_instance_count;
    }

    /** \dref_DataReaderCacheStatus_disposed_instance_count_peak */
    int64_t disposed_instance_count_peak() const
    {
        return native().disposed_instance_count_peak;
    }

    /** \dref_DataReaderCacheStatus_detached_instance_count */
    int64_t detached_instance_count() const
    {
        return native().detached_instance_count;
    }

    /** \dref_DataReaderCacheStatus_detached_instance_count_peak */
    int64_t detached_instance_count_peak() const
    {
        return native().detached_instance_count_peak;
    }

    /** \dref_DataReaderCacheStatus_compressed_sample_count */
    int64_t compressed_sample_count() const
    {
        return native().compressed_sample_count;
    }
};
...
public:
    ...
    /** \dref_DataReaderProtocolStatus_received_fragment_count
     */
    int64_t received_fragment_count() const
    {
        return native().received_fragment_count;
    }
    /** \dref_DataReaderProtocolStatus_dropped_fragment_count
     */
    int64_t dropped_fragment_count() const
    {
        return native().dropped_fragment_count;
    }
    /** \dref_DataReaderProtocolStatus_reassembled_sample_count
     */
    int64_t reassembled_sample_count() const
    {
        return native().reassembled_sample_count;
    }
    /** \dref_DataReaderProtocolStatus_sent_nack_fragment_count
     */
    int64_t sent_nack_fragment_count() const
    {
        return native().sent_nack_fragment_count;
    }
    /** \dref_DataReaderProtocolStatus_sent_nack_fragment_bytes
     */
    int64_t sent_nack_fragment_bytes() const
    {
        return native().sent_nack_fragment_bytes;
    }

    /** \dref_DataReaderProtocolStatus_out_of_range_rejected_sample_count
     */
    int64_t out_of_range_rejected_sample_count() const
    {
        return native().out_of_range_rejected_sample_count;
    }
...
public:
    ...
    /** \dref_DataWriterCacheStatus_alive_instance_count */
    int64_t alive_instance_count() const
    {
        return native().alive_instance_count;
    }

    /** \dref_DataWriterCacheStatus_alive_instance_count_peak */
    int64_t alive_instance_count_peak() const
    {
        return native().alive_instance_count_peak;
    }

    /** \dref_DataWriterCacheStatus_disposed_instance_count */
    int64_t disposed_instance_count() const
    {
        return native().disposed_instance_count;
    }

    /** \dref_DataWriterCacheStatus_disposed_instance_count_peak */
    int64_t disposed_instance_count_peak() const
    {
        return native().disposed_instance_count_peak;
    }

    /** \dref_DataWriterCacheStatus_unregistered_instance_count */
    int64_t unregistered_instance_count() const
    {
        return native().unregistered_instance_count;
    }

    /** \dref_DataWriterCacheStatus_unregistered_instance_count_peak */
    int64_t unregistered_instance_count_peak() const
    {
        return native().unregistered_instance_count_peak;
    }
};
...
public:
    ...
    /** \dref_ReliableWriterCacheChangedStatus_replaced_unacknowledged_sample_count
     */
    int64_t replaced_unacknowledged_sample_count() const
    {
        return native().replaced_unacknowledged_sample_count;
    }
};
...
public:
    ...
    /** \dref_DataWriterProtocolStatus_pushed_fragment_count
     */
    int64_t pushed_fragment_count() const
    {
        return native().pushed_fragment_count;
    }
    /** \dref_DataWriterProtocolStatus_pushed_fragment_bytes
     */
    int64_t pushed_fragment_bytes() const
    {
        return native().pushed_fragment_bytes;
    }
    /** \dref_DataWriterProtocolStatus_pulled_fragment_count
     */
    int64_t pulled_fragment_count() const
    {
        return native().pulled_fragment_count;
    }
    /** \dref_DataWriterProtocolStatus_pulled_fragment_bytes
     */
    int64_t pulled_fragment_bytes() const
    {
        return native().pulled_fragment_bytes;
    }
    /** \dref_DataWriterProtocolStatus_received_nack_fragment_count
     */
    int64_t received_nack_fragment_count() const
    {
        return native().received_nack_fragment_count;
    }
    /** \dref_DataWriterProtocolStatus_received_nack_fragment_bytes
     */
    int64_t received_nack_fragment_bytes() const
    {
        return native().received_nack_fragment_bytes;
    }
};
