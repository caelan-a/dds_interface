...
protected:
    Entity(DDS_Entity *native_entity, detail::ListenerHolderPtr listener_holder);
    Entity(const std::pair<DDS_Entity *, bool> &native_entity_enable,
           detail::ListenerHolderPtr listener_holder);
...
protected:
    ...
    void assert_legal_listener_setter_call(bool user_call) const;
...
private:
    ...
    mutable rti::core::cond::StatusCondition::weak_ref_type status_condition_weak_ref_;
    bool created_from_c_;
    bool needs_enable_;

protected:
    detail::ListenerHolderPtr listener_holder_;
};
