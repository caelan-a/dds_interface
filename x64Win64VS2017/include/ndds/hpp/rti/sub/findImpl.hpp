 ...
 * where the DataReaders will be copied into
 ...
 * @param begin A forward iterator to the position in the destination container 
 * where the DataReaders will be copied into. This container should be a container
 ...
 * @return The DataReader with the given topic name, or dds::core::null if it
 * doesn't exist
 *
 * @see \ref DDSReaderExampleModule_lookup
 */
 ...
 * @return The DataReader with the given name, or dds::core::null if it doesn't
 * exist
 *
 * @see \ref DDSReaderExampleModule_lookup
 */
