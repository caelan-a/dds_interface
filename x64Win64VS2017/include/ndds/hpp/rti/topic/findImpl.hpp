...
/**
 * @brief @extension Lookup the names of up to max_size number of the custom
 * content filters registered to a dds::domain::DomainParticipant
 *
 * @namespace_note rti::topic
 *
