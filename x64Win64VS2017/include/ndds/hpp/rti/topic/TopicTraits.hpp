...
typename rtiboost::enable_if_c<
        !rtiboost::is_arithmetic<T>::value && !rtiboost::is_enum<T>::value,
        void>::type
...
template<typename T>
typename rtiboost::enable_if_c<rtiboost::is_enum<T>::value, void>::type
reset_sample(T& value)
{
...
template <typename T>
typename rtiboost::enable_if_c<!rtiboost::is_arithmetic<T>::value && !rtiboost::is_enum<T>::value, void>::type
