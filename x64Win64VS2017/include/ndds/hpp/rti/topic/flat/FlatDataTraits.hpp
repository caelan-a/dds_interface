...
// This tells the FlatData infrastructure how to default-initialize an enum
// class using the generated default_enumerator traits.
template <typename Enum>
struct default_primitive_value<
        Enum,
        typename rtiboost::enable_if_c<rtiboost::is_enum<Enum>::value>::type> {
    static Enum get()
    {
        return rti::topic::default_enumerator<Enum>::value;
    }
};
