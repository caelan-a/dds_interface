...
public:
    ContentFilteredTopicImpl(
            ...
            : UntypedTopicDescription(
                    ...
                    the_name,
                    the_topic.type_name(),
                    // A CFT doesn't have a listener, but because the spec incorrectly
                    // makes TopicDescription derive from Entity we need to pass
                    // a listener holder to the Entity
                    detail::ListenerHolderPtr(new detail::ListenerHolder())),
              topic_(the_topic)
    {
    }
    ...
    ContentFilteredTopicImpl(
            ...
            : UntypedTopicDescription(
                    ...
                    detail::ListenerHolderPtr(new detail::ListenerHolder())),
              topic_(rti::core::detail::create_from_native_entity<
                      dds::topic::Topic<T> >(
