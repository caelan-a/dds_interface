...
public:
    ...
    TopicBuiltinTopicDataImpl(TopicBuiltinTopicDataImpl&& other) OMG_NOEXCEPT
        : name_(dds::core::string::create_null_tag_t()),
          type_name_(dds::core::string::create_null_tag_t())
    {
        swap(*this, other);
    }
...
public:
    ...
    PublicationBuiltinTopicDataImpl(PublicationBuiltinTopicDataImpl &&other)
            OMG_NOEXCEPT 
        : topic_name_(dds::core::string::create_null_tag_t()),
          type_name_(dds::core::string::create_null_tag_t())
    {
        swap(*this, other);
    }
...
private:
    ...
    */
    ...
    dds::core::policy::DataTag data_tag_;
...
public:
    ...
    SubscriptionBuiltinTopicDataImpl(SubscriptionBuiltinTopicDataImpl &&other) OMG_NOEXCEPT 
        : topic_name_(dds::core::string::create_null_tag_t()),
          type_name_(dds::core::string::create_null_tag_t())
    {
        swap(*this, other);
...
public:
    ...
    #ifndef RTI_CXX11_NO_IMPLICIT_MOVE_OPERATIONS
    VirtualSubscriptionBuiltinTopicData(
            const VirtualSubscriptionBuiltinTopicData&) = default;
