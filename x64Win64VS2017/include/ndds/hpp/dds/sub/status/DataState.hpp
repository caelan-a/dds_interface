...
public:
     ...
     *
     * Indicates that the application has already accessed that sample by means
     * of a read or take operation.
     */
...
public:
     ...
     *
     * A new_view ViewState indicates that the latest generation of the instance
     * has not previously been accessed.
     */
     ...
     *
     * Indicates that the latest generation of an instance has previously been
     * accessed.
     */
    ...
    /**
     * @brief Creates a ViewState object representing any view state
     *
...
public:
     ...
     * (according to the dds::core::policy::Liveliness policy) are writing the
     * instance.
     */
    ...
    /**
     * @brief Creates an InstanceState object representing any instance state
     *
...
/**
 * @relatesalso SampleState
 *
 * @brief Prints a sample state as a readable string
 */
OMG_DDS_API
std::ostream& operator<<(std::ostream& os, const SampleState& s);

/**
 * @relatesalso ViewState
 *
 * @brief Prints a view state as a readable string
 */
OMG_DDS_API
...
/**
 * @relatesalso InstanceState
 *
 * @brief Prints an instance state as a readable string
 */
OMG_DDS_API
std::ostream& operator<<(std::ostream& os, const InstanceState& s);

/**
 * @relatesalso DataState
 *
 * @brief Prints a data state as a readable string
 */
OMG_DDS_API
std::ostream& operator<<(std::ostream& os, const DataState& s);

#endif // OMG_DDS_HAS_PRETTY_PRINT_COUT
