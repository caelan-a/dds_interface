...
#ifdef RTIBOOST_NO_CXX11_EXPLICIT_CONVERSION_OPERATORS
#define RTI_NO_CXX11_EXPLICIT_CONVERSION_OPERATORS
#define RTI_EXPLICIT_CONVERSION
#else
#define RTI_EXPLICIT_CONVERSION explicit
#endif

#if defined(RTIBOOST_NO_CXX17_HDR_OPTIONAL)
...
#if defined(RTIBOOST_NO_CXX11_HDR_FUTURE)
...
#if defined(RTI_NO_CXX11_HDR_FUTURE) || defined(RTIBOOST_NO_CXX11_LAMBDAS) \
