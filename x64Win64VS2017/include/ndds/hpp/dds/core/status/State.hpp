...
public:
    ...
    {
        return SampleRejectedState(DDS_REJECTED_BY_INSTANCES_LIMIT);
    }
    ...
    /** \dref_SampleRejectedStatusKind_REJECTED_BY_DECODE_FAILURE */
    static const SampleRejectedState rejected_by_decode_failure()
    {
        return SampleRejectedState(DDS_REJECTED_BY_DECODE_FAILURE);
    }
