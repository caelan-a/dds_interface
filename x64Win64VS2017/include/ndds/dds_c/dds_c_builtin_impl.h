...
/*
 * @(#)dds_c_builtin_impl.h    generated by: makeheader    Fri Apr 23 00:05:58 2021
 *
...
DDS_ParticipantBuiltinTopicDataPlugin_new(void);
...
DDS_ParticipantBuiltinTopicDataPluginSupport_create_data(void);
...
DDS_ParticipantBuiltinTopicDataReverseTransform(
        const struct DDS_ParticipantBuiltinTopicData *in,
        struct DISCBuiltinTopicParticipantData *out);

extern DDSCDllExport void 
DDS_ParticipantBuiltinTopicDataReverseTransform_free_allocated_buffers(
        struct DISCBuiltinTopicParticipantData* self);

 extern DDSCDllVariable const char *DDS_TOPIC_TYPE_NAME;

extern DDSCDllExport struct PRESTypePlugin* 
DDS_TopicBuiltinTopicDataPlugin_new(void);
...
DDS_TopicBuiltinTopicDataPluginSupport_create_data(void);
...
extern DDSCDllExport struct PRESTypePlugin* 
DDS_PublicationBuiltinTopicDataPlugin_new(void);
...
extern DDSCDllExport struct DDS_PublicationBuiltinTopicData * 
DDS_PublicationBuiltinTopicDataPluginSupport_create_data(void);
...
extern DDSCDllExport struct PRESTypePlugin* 
DDS_SubscriptionBuiltinTopicDataPlugin_new(void);
...
extern DDSCDllExport struct DDS_SubscriptionBuiltinTopicData *
DDS_SubscriptionBuiltinTopicDataPluginSupport_create_data(void);
...
extern DDSCDllExport struct PRESTypePlugin* 
DDS_VirtualSubscriptionBuiltinTopicDataPlugin_new(void);
...
extern DDSCDllExport struct DDS_VirtualSubscriptionBuiltinTopicData *
DDS_VirtualSubscriptionBuiltinTopicDataPluginSupport_create_data(void);
...
#define DDS_BUILTIN_TYPE_PLUGIN_DEFAULT_MODE_PROPERTY_NAME \
    PROPERTY_NAME_DDS_BUILTIN_DISCOVERY_IS_SIMPLE_PLUGIN
