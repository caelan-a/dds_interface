...
/*
 * @(#)dds_c_typecode_impl.h    generated by: makeheader    Fri Apr 23 00:06:18 2021
 *
...
DDS_TypeCodeFactory *DDS_TypeCodeFactory_get_stateless_instance(void);
...
extern DDSCDllExport
void DDS_TypeCodeFactory_delete_builtin_tcI(
        DDS_TypeCodeFactory *self,
        DDS_TypeCode *tc,
        DDS_ExceptionCode_t *ex);
...
extern DDSCDllExport
void DDS_TypeCode_set_sample_access_infoI(
    DDS_TypeCode *self,
    RTIXCdrSampleAccessInfo *accessInfo);

extern DDSCDllExport
void DDS_TypeCode_set_type_pluginI(
    DDS_TypeCode *self,
    RTIXCdrTypePlugin *typePlugin);

extern DDSCDllExport
void DDS_TypeCode_set_sequence_saiI(DDS_TypeCode *self);

extern DDSCDllExport
void DDS_TypeCode_set_external_array_saiI(
        DDS_TypeCode *self,
        RTIXCdrSampleAccessInfo *accessInfo);

extern DDSCDllExport
void DDS_TypeCode_set_is_copyableI(
        DDS_TypeCode *self,
        DDS_Boolean copyable);
