...
/*
 * @(#)dds_c_topic.h    generated by: makeheader    Fri Apr 23 00:06:12 2021
 *
...
struct DDS_TopicQos {
    ...
    */ 
    ...
    /*e \dref_TopicQos_print */
    DDS_ReturnCode_t print() const {
        return DDS_TopicQos_print(this);
    }

    /*e \dref_TopicQos_to_string */
    DDS_ReturnCode_t to_string(
            char *string,
            DDS_UnsignedLong& string_size) const {
        return DDS_TopicQos_to_string(this, string, &string_size);
    }


    /*e \dref_TopicQos_to_string_w_base */
    DDS_ReturnCode_t to_string(
            char *string,
            DDS_UnsignedLong& string_size,
            const DDS_TopicQos& base) const {
        const DDS_QosPrintFormat format = DDS_QosPrintFormat_INITIALIZER;
        return DDS_TopicQos_to_string_w_params(
                this,
                string,
                &string_size,
                &base,
    ...
    /*e \dref_TopicQos_to_string_w_format */
    DDS_ReturnCode_t to_string(
            char *string,
            DDS_UnsignedLong& string_size,
        ...
        DDS_TopicQos base;
        retcode = DDS_TopicQos_initialize(&base);
        if (retcode != DDS_RETCODE_OK) {
            return retcode;
        }
        retcode = DDS_TopicQos_to_string_w_params(
                this,
                string,
                &string_size,
                &base,
                &format);
        DDS_TopicQos_finalize(&base);
        return retcode;
    }

    /*e \dref_TopicQos_to_string_w_params */
    DDS_ReturnCode_t to_string(
            char *string,
            DDS_UnsignedLong& string_size,
    ...
    /*e \dref_TopicQos_to_string_w_print_all */
    DDS_ReturnCode_t to_string(
            char *string,
            DDS_UnsignedLong& string_size,
    ...
    /*e \dref_TopicQos_to_string_w_format_print_all */
    DDS_ReturnCode_t to_string(
            char *string,
            DDS_UnsignedLong& string_size,
