...
/*
 * @(#)dds_c_builtintypes.h    generated by: makeheader    Fri Apr 23 00:05:58 2021
 *
...
DDS_TypeCode * DDS_String_get_typecode(void); /* Type code */
...
extern DDSCDllExport
DDS_TypeCode * DDS_Octets_get_typecode(void); /* Type code */
...
extern DDSCDllExport
DDS_TypeCode * DDS_KeyedString_get_typecode(void); /* Type code */
...
extern DDSCDllExport
DDS_TypeCode * DDS_KeyedOctets_get_typecode(void); /* Type code */


DDS_SEQUENCE(DDS_KeyedOctetsSeq, DDS_KeyedOctets);

extern DDSCDllExport
DDS_Octets * DDS_Octets_new(void);
...
extern DDSCDllExport
DDS_KeyedOctets * DDS_KeyedOctets_new(void);
...
DDSCDllExport
char * DDS_StringTypeSupport_create_data(void);
...
DDSCDllExport
void DDS_StringTypeSupport_finalize(void);
 ...
 */
DDSCDllExport const char * DDS_OctetsTypeSupport_get_type_name(void);
...
*/
DDSCDllExport
DDS_TypeCode * DDS_OctetsTypeSupport_get_typecode(void);
 ...
 */
DDSCDllExport
const char * DDS_KeyedOctetsTypeSupport_get_type_name(void);
...
*/
DDSCDllExport
DDS_TypeCode * DDS_KeyedOctetsTypeSupport_get_typecode(void);
