...
/*
 * @(#)dds_c_typecode.h    generated by: makeheader    Fri Apr 23 00:06:18 2021
 *
...
typedef struct DDS_AnnotationParameterValue {

    DDS_TCKind _d;
    union DDS_AnnotationParameterValue_u {
        DDS_Boolean boolean_value;
        DDS_Octet octet_value;
        DDS_Short short_value;
        DDS_UnsignedShort ushort_value;
        DDS_Long long_value;
        DDS_UnsignedLong ulong_value;
        DDS_LongLong long_long_value;
        DDS_UnsignedLongLong ulong_long_value;
        DDS_Float float_value;
        DDS_Double double_value;
        /* DDS_LongDouble long_double_value; Not supported yet */
        DDS_Char char_value;
        DDS_Wchar wchar_value;
        DDS_Long enumerated_value;
        DDS_Char *string_value;
        DDS_Wchar *wstring_value;
    } _u;
...
struct DDS_TYPECODE_DLL_EXPORT DDS_TypeCode {
    ...
    /*e \dref_TypeCode_cdr_serialized_sample_max_size */
    DDS_UnsignedLong cdr_serialized_sample_max_size(
        DDS_DataRepresentationId_t representation_id,
        DDS_ExceptionCode_t & ex) const;

    /*e \dref_TypeCode_cdr_serialized_sample_min_size */
    DDS_UnsignedLong cdr_serialized_sample_min_size(
        DDS_DataRepresentationId_t representation_id,
        DDS_ExceptionCode_t & ex) const;

    /*e \dref_TypeCode_cdr_serialized_sample_key_max_size */
    DDS_UnsignedLong cdr_serialized_sample_key_max_size(
        DDS_DataRepresentationId_t representation_id,
        DDS_ExceptionCode_t & ex) const;

    /*e \dref_TypeCode_cdr_serialized_sample_max_size_wo_representation_id */
    DDS_UnsignedLong cdr_serialized_sample_max_size(
        DDS_ExceptionCode_t & ex) const;

    /*e \dref_TypeCode_cdr_serialized_sample_min_size_wo_representation_id */
    DDS_UnsignedLong cdr_serialized_sample_min_size(
        DDS_ExceptionCode_t & ex) const;

    /*e \dref_TypeCode_cdr_serialized_sample_key_max_size_wo_representation_id */
    DDS_UnsignedLong cdr_serialized_sample_key_max_size(
        DDS_ExceptionCode_t & ex) const;
    ...
    /*e \dref_TypeCode_default_value */
    const DDS_AnnotationParameterValue * default_value(
            DDS_ExceptionCode_t & ex);

    /*e \dref_TypeCode_min_value */
    const DDS_AnnotationParameterValue * min_value(
            DDS_ExceptionCode_t & ex);

    /*e \dref_TypeCode_max_value */
    const DDS_AnnotationParameterValue * max_value(
            DDS_ExceptionCode_t & ex);

    /*e \dref_TypeCode_member_default_value */
    const DDS_AnnotationParameterValue * member_default_value(
            DDS_UnsignedLong index,
            DDS_ExceptionCode_t & ex);

    /*e \dref_TypeCode_member_min_value */
    const DDS_AnnotationParameterValue * member_min_value(
            DDS_UnsignedLong index,
            DDS_ExceptionCode_t & ex);

    /*e \dref_TypeCode_member_max_value */
    const DDS_AnnotationParameterValue * member_max_value(
            DDS_UnsignedLong index,
            DDS_ExceptionCode_t & ex);
...
extern DDSCDllExport DDS_TypeCodeFactory * DDS_TypeCodeFactory_get_instance(void);
