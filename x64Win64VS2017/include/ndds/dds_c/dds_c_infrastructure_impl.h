...
/*
 * @(#)dds_c_infrastructure_impl.h    generated by: makeheader    Fri Apr 23 00:06:00 2021
 *
...
#define DDS_WAITSET_EXCLUSIVE_AREA_NAME "DDS_WAITSET_EA"

 extern DDSCDllVariable const int DDS_CONDITION_EXCLUSIVE_AREA_LEVEL;


#define DDS_CONDITION_EXCLUSIVE_AREA_NAME "DDS_CONDITION_EA"
...
extern DDSCDllExport
size_t DDS_WaitSet_sizeof(void);
...
extern DDSCDllExport 
DDS_CountingCondition * DDS_CountingCondition_new(void);
...
extern DDSCDllExport
struct REDAWorker * DDS_DomainEntity_create_worker_with_nameI(
        DDS_Entity *self,
        const char *name);
...
extern DDSCDllExport
void DDS_DomainParticipantProtocolQosPolicy_save(
    const struct DDS_DomainParticipantProtocolQosPolicy* self,
    const struct DDS_DomainParticipantProtocolQosPolicy* base,
...
extern DDSCDllExport
void DDS_TransportEncapsulationQosPolicy_save(
        const struct DDS_TransportEncapsulationQosPolicy* self,
        const struct DDS_TransportEncapsulationQosPolicy* base,
        struct RTIXMLSaveContext *dst);
...
DDS_PublisherProtocolQosPolicy_save(
        const struct DDS_PublisherProtocolQosPolicy *self,
        const struct DDS_PublisherProtocolQosPolicy *base,
        DDS_Boolean isPrivate,
...
extern DDSCDllExport void
DDS_SubscriberProtocolQosPolicy_save(
    const struct DDS_SubscriberProtocolQosPolicy *self,
    const struct DDS_SubscriberProtocolQosPolicy *base,
    DDS_Boolean isPrivate,
    DDS_Boolean printPrivate,
    struct RTIXMLSaveContext *dst);
...
extern DDSCDllExport
int DDS_ProductVersion_compare(
...
extern DDSCDllExport
DDS_Boolean DDS_Short_equals(
        const DDS_Short *left,
        const DDS_Short *right);

extern DDSCDllExport
DDS_Boolean DDS_ShortSeq_equals(
        const struct DDS_ShortSeq *left,
        const struct DDS_ShortSeq *right);

extern DDSCDllExport
DDS_Boolean DDS_Long_equals(
        const DDS_Long *left,
        const DDS_Long *right);

extern DDSCDllExport
DDS_Boolean DDS_LongSeq_equals(
        const struct DDS_LongSeq *left,
        const struct DDS_LongSeq *right);
...
extern DDSCDllExport void
DDS_UserObjectQosPolicy_save(
        const struct DDS_UserObjectQosPolicy *self,
        const struct DDS_UserObjectQosPolicy *base,
        DDS_Boolean isPrivate,
        struct RTIXMLSaveContext *dst);
...
extern DDSCDllExport void
DDS_TopicProtocolQosPolicy_save(
        const struct DDS_TopicProtocolQosPolicy *self,
        const struct DDS_TopicProtocolQosPolicy *base,
        DDS_Boolean isPrivate,
        DDS_Boolean printPrivate,
        struct RTIXMLSaveContext *dst);
...
extern DDSCDllExport
void DDS_SystemResourceLimitsQosPolicy_save(
        const struct DDS_SystemResourceLimitsQosPolicy *self,
        const struct DDS_SystemResourceLimitsQosPolicy *base,
        DDS_Boolean isPrivate,
        struct RTIXMLSaveContext *dst);
...
extern DDSCDllExport
void DDS_EndpointGroupSeq_save(
        const char *tag_name,
        const struct DDS_EndpointGroupSeq *self,
        const struct DDS_EndpointGroupSeq *base,
        struct RTIXMLSaveContext *dst);
...
extern DDSCDllExport
void DDS_TransportMulticastMappingQosPolicy_save(
        const struct DDS_TransportMulticastMappingQosPolicy *self,
        const struct DDS_TransportMulticastMappingQosPolicy *base,
        struct RTIXMLSaveContext *dst);
...
extern DDSCDllExport
DDS_ReturnCode_t DDS_StringSeq_from_delimited_string(
...
extern DDSCDllExport
DDS_Boolean DDS_StringSeq_equals(
...
extern DDSCDllExport
DDS_Boolean DDS_Octet_equals(
        const DDS_Octet *left,
        const DDS_Octet *right);

extern DDSCDllExport
void DDS_OctetSeq_print(const struct DDS_OctetSeq *self);

extern DDSCDllExport
DDS_Boolean DDS_UInt8Seq_equals(
        const struct DDS_UInt8Seq *left,
        const struct DDS_UInt8Seq *right);

extern DDSCDllExport
DDS_Boolean DDS_UInt8_equals(
        const DDS_UInt8 *left,
        const DDS_UInt8 *right);

extern DDSCDllExport
void DDS_UInt8Seq_print(const struct DDS_UInt8Seq *self);

extern DDSCDllExport
DDS_Boolean DDS_Int8Seq_equals(
        const struct DDS_Int8Seq *left,
        const struct DDS_Int8Seq *right);

extern DDSCDllExport
DDS_Boolean DDS_Int8_equals(
        const DDS_Int8 *left,
        const DDS_Int8 *right);

extern DDSCDllExport
void DDS_Int8Seq_print(const struct DDS_Int8Seq *self);
...
extern DDSCDllExport DDS_Boolean
DDS_DataReaderResourceLimitsInstanceReplacementSettings_equals(
        const struct DDS_DataReaderResourceLimitsInstanceReplacementSettings *left,
        const struct DDS_DataReaderResourceLimitsInstanceReplacementSettings *right);
...
#define DDS_TIME_NSEC_IN_SEC   (1000000000)
...
#define DDS_SHARED_SUBSCRIBER_NAME_PROPERTY PROPERTY_NAME_DDS_DATA_READER_SHARED_SUBSCRIBER_NAME
