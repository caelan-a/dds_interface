...
/*
 * @(#)dds_c_infrastructure.h    generated by: makeheader    Fri Apr 23 00:06:00 2021
 *
...
#define DDS_DURATION_INFINITE_NSEC_VALUE 0x7fffffff
...
void DDS_Duration_save(const char * tag_name,
                       ...
                       const struct DDS_Duration_t * base,
...
#define DDS_GUID_DEFAULT { \
 ...
 extern DDSCDllVariable const struct DDS_GUID_t DDS_GUID_ZERO;
...
void DDS_ThreadSettings_save(const char * tag_name,
                             ...
                             const struct DDS_ThreadSettings_t * base,
                             struct RTIXMLSaveContext * dst);


/*e \dref_QosPrintFormat_INITIALIZER */
...
struct DDS_QosPrintFormat {
    /*e \dref_QosPrintFormat_is_standalone */
    DDS_Boolean is_standalone;
    /*e \dref_QosPrintFormat_print_private */
    DDS_Boolean print_private;
    /*e \dref_QosPrintFormat_indent */
...
struct DDS_DurabilityQosPolicy {
    ...
    */
    ...
    /*e \dref_DurabilityQosPolicy_writer_depth
    */
...
struct DDS_PresentationQosPolicy {
    ...
    /*e \dref_PresentationQosPolicy_drop_incomplete_coherent_set
     */
...
extern DDSCDllExport
void DDS_LatencyBudgetQosPolicy_save(
        const char *tagName,
...
#define DDS_HISTORY_QOS_POLICY_DEFAULT { DDS_KEEP_LAST_HISTORY_QOS, 1}
...
{ DDS_BOOLEAN_FALSE, {0x7fffffffL, 0x7fffffffUL}, {0x7fffffffL, 0x7fffffffUL}}


#define DDS_BUITLIN_WRITER_DATA_LIFECYCLE_QOS_POLICY_DEFAULT \
{ DDS_BOOLEAN_FALSE, {0L, 0UL}, {0x7fffffffL, 0x7fffffffUL}}
...
struct DDS_ReaderDataLifecycleQosPolicy {
     ...
     */
    struct DDS_Duration_t autopurge_disposed_instances_delay;
    /*e \dref_ReaderDataLifecycleQosPolicy_autopurge_nowriter_instances_delay
     */
...
{ {0x7fffffffL, 0x7fffffffUL}, /* autopurge_nowriter_samples_delay */ \
  {0x7fffffffL, 0x7fffffffUL}, /* autopurge_disposed_samples_delay */ \
  {0x7fffffffL, 0x7fffffffUL}, /* autopurge_disposed_instances_delay */ \
  {0x0L, 0x0UL}}  /* autopurge_nowriter_instances_delay */
...
void DDS_AllocationSettings_save(const char * tag_name,
                                 ...
                                 const struct DDS_AllocationSettings_t * base,
                                 struct RTIXMLSaveContext* dst);
...
struct DDS_RtpsReliableWriterProtocol_t {
    ...
    /*e \dref_RtpsReliableWriterProtocol_t_disable_repair_piggyback_heartbeat
     */
...
#define DDS_RTPS_RELIABLE_WRITER_PROTOCOL_DISCOVERY_CONFIG_SECURE_VOLATILE_DEFAULT { \
    /* watermarks */                         0, 1,                         \
    /* hb periods */                         {1, 0}, {0, 250000000}, {1, 0}, \
    /* virtual hb period */                  {0x7fffffffL, 0x7fffffffUL},  \
    /* samples / virtual hb */               -1,                           \
    /* hb retries */                         -1,                           \
    /* inactivate nonprogressing readers */  DDS_BOOLEAN_FALSE,            \
    ...
    /* min send window size */               -1,                           \
    /* max send window size */               -1,                           \
    /* send window update period */          {1L, 0UL},                    \
    /* send window increase factor */        105,                          \
    /* send window decrease factor */        50,                           \
    /* enable_multicast_periodic_hb */       DDS_BOOLEAN_FALSE,            \
    /* multicast_resend_threshold */         2,                            \
...
#elif defined(RTI_DARWIN) || defined (RTI_VXWORKS_CLANG)
...
void DDS_TransportMulticastSettingsSeq_save(const char * tag_name,
                                            ...
                                            const struct DDS_TransportMulticastSettingsSeq *base,
                                            struct RTIXMLSaveContext* dst);
...
typedef enum {
     ...
     */
    DDS_TRANSPORTBUILTIN_UDPv4 = 0x00000001 << 0,

    /*e \dref_TransportBuiltinKind_TRANSPORTBUILTIN_SHMEM
     */
    DDS_TRANSPORTBUILTIN_SHMEM = 0x00000001 << 1,
     ...
     */
    DDS_TRANSPORTBUILTIN_UDPv6 = 0x00000001 << 3,

    /*e \dref_TransportBuiltinKind_TRANSPORTBUILTIN_UDPv4_WAN
     */
    DDS_TRANSPORTBUILTIN_UDPv4_WAN = 0x00000001 << 4
...
DDS_SEQUENCE(DDS_LocatorSeq, struct DDS_Locator_t);
 ...
 extern DDSCDllVariable const DDS_Long DDS_LOCATOR_KIND_UDPv4_WAN;
...
#define DDS_PRODUCTVERSION_MAJOR_UNKNOWN (0)
#define DDS_PRODUCTVERSION_MINOR_UNKNOWN (0)
#define DDS_PRODUCTVERSION_RELEASE_UNKNOWN (0)
#define DDS_PRODUCTVERSION_REVISION_UNKNOWN (0)
...
typedef enum {
    /*e \dref_DataReaderInstanceRemovalKind_NO_INSTANCE_REMOVAL
    */
    DDS_NO_INSTANCE_REMOVAL = PRES_NO_INSTANCE_REMOVAL,
    /*e \dref_DataReaderInstanceRemovalKind_EMPTY_INSTANCE_REMOVAL
    */
    DDS_EMPTY_INSTANCE_REMOVAL = PRES_EMPTY_INSTANCE_REMOVAL,
    /*e \dref_DataReaderInstanceRemovalKind_FULLY_PROCESSED_INSTANCE_REMOVAL
    */
    DDS_FULLY_PROCESSED_INSTANCE_REMOVAL = PRES_FULLY_PROCESSED_INSTANCE_REMOVAL,
    /*e \dref_DataReaderInstanceRemovalKind_ANY_INSTANCE_REMOVAL
    */
...
struct DDS_DataReaderResourceLimitsInstanceReplacementSettings {
    /*e \dref_DataReaderResourceLimitsInstanceReplacementSettings_alive_instance_removal */
    DDS_DataReaderInstanceRemovalKind alive_instance_removal;
    /*e \dref_DataReaderResourceLimitsInstanceReplacementSettings_disposed_instance_removal */
    DDS_DataReaderInstanceRemovalKind disposed_instance_removal;
    /*e \dref_DataReaderResourceLimitsInstanceReplacementSettings_no_writers_instance_removal */
    DDS_DataReaderInstanceRemovalKind no_writers_instance_removal;
};


#define DDS_DataReaderResourceLimitsInstanceReplacementSettings_DEFAULT { \
        DDS_NO_INSTANCE_REMOVAL, /* alive_instance_removal */ \
        DDS_EMPTY_INSTANCE_REMOVAL, /* disposed_instance_removal */ \
        DDS_EMPTY_INSTANCE_REMOVAL /* no_writers_instance_removal */ \
    }
...
#define DDS_DATA_READER_RESOURCE_LIMITS_QOS_POLICY_DEFAULT { \
    ...
    DDS_DataReaderResourceLimitsInstanceReplacementSettings_DEFAULT /* instance_replacement */ \
}
...
extern DDSCDllExport
void DDS_DataWriterResourceLimitsQosPolicy_save(
...
extern DDSCDllExport void
DDS_ServiceQosPolicy_save(
        const struct DDS_ServiceQosPolicy* self,
        const struct DDS_ServiceQosPolicy* base,
        DDS_Boolean isPrivate,
        struct RTIXMLSaveContext* dst);
...
extern DDSCDllExport
void DDS_DataWriterProtocolQosPolicy_save(
...
#define DDS_SYSTEM_RESOURCE_LIMITS_QOS_MAX_OBJECTS_PER_THREAD_DEFAULT 2048
#define DDS_SYSTEM_RESOURCE_LIMITS_QOS_POLICY_DEFAULT { \
    DDS_SYSTEM_RESOURCE_LIMITS_QOS_MAX_OBJECTS_PER_THREAD_DEFAULT \
}
...
struct DDS_DomainParticipantResourceLimitsQosPolicy {
    ...
    /*e \dref_DomainParticipantResourceLimitsQosPolicy_serialized_type_object_dynamic_allocation_threshold
     */
...
extern DDSCDllExport
void DDS_DatabaseQosPolicy_save(
        const struct DDS_DatabaseQosPolicy* self,
...
extern DDSCDllExport
void DDS_ReceiverPoolQosPolicy_save(
        const struct DDS_ReceiverPoolQosPolicy* self,
...
extern DDSCDllExport
void DDS_PublishModeQosPolicy_save(
        const char * tag_name,
...
struct DDS_DiscoveryConfigQosPolicy {
    ...
    */
    ...
    /*e \dref_DiscoveryConfigQosPolicy_secure_volatile_writer
     */
    ...
    /*e \dref_DiscoveryConfigQosPolicy_secure_volatile_reader
     */
    ...
    /*e \dref_DiscoveryConfigQosPolicy_dns_tracker_polling_period
     */
...
DDS_RTPS_RELIABLE_WRITER_PROTOCOL_DISCOVERY_CONFIG_SECURE_VOLATILE_DEFAULT, /* secure_volatile_writer */\
DDS_PUBLISH_MODE_QOS_POLICY_DEFAULT, /* secure_volatile_writer_publish_mode */\
DDS_RTPS_RELIABLE_READER_PROTOCOL_DISCOVERY_CONFIG_DEFAULT, /* secure_volatile_reader */\
...
{ DDS_DURATION_INFINITE_NSEC_VALUE, DDS_DURATION_INFINITE_NSEC_VALUE }, /* dns_tracker_polling_period */\
...
extern DDSCDllExport
void DDS_DiscoveryConfigQosPolicy_save(
        const struct DDS_DiscoveryConfigQosPolicy* self,
...
extern DDSCDllExport
void DDS_TypeSupportQosPolicy_save(
        const struct DDS_TypeSupportQosPolicy *self,
        const struct DDS_TypeSupportQosPolicy *base,
        struct RTIXMLSaveContext* dst);
...
extern DDSCDllExport
void DDS_ExclusiveAreaQosPolicy_save(
        const struct DDS_ExclusiveAreaQosPolicy* self,
...
#define DDS_TYPE_CONSISTENCY_ENFORCEMENT_QOS_POLICY_DEFAULT { \
    DDS_AUTO_TYPE_COERCION, \
    DDS_BOOLEAN_TRUE, /* ignore_sequence_bounds */ \
    DDS_BOOLEAN_TRUE, /* ignore_string_bounds */ \
...
void DDS_ChannelSettingsSeq_save(const char * tag_name,
                                 ...
                                 const struct DDS_ChannelSettingsSeq *base,
                                 struct RTIXMLSaveContext* dst);
...
extern DDSCDllExport
DDS_Boolean DDS_PropertyQosPolicyHelper_lookup_boolean_property(
        struct DDS_PropertyQosPolicy *self,
        DDS_Boolean *value,
        const char *name);
...
#define DDS_AVAILABILITY_QOS_POLICY_DEFAULT { \
  ...
  { -1, 0UL }, /* max_data_availability_waiting_time */\
  { -1, 0UL }, /* max_endpoint_availability_waiting_time */ \
...
extern DDSCDllExport
void DDS_WaitSetProperty_save(
        const struct DDS_WaitSetProperty_t *self,
        const struct DDS_WaitSetProperty_t *base,
        struct RTIXMLSaveContext* dst);
...
extern DDSCDllExport
void DDS_ProfileQosPolicy_save(
        const struct DDS_ProfileQosPolicy* self,
        const struct DDS_ProfileQosPolicy* base,
        DDS_Boolean isPrivate,
        struct RTIXMLSaveContext *dst);
...
typedef DDS_UnsignedLong DDS_CompressionId_t;
 ...
 extern DDSCDllVariable const DDS_CompressionId_t DDS_COMPRESSION_ID_ZLIB;

 extern DDSCDllVariable const DDS_CompressionId_t
        DDS_COMPRESSION_ID_BZIP2;

 extern DDSCDllVariable const DDS_CompressionId_t DDS_COMPRESSION_ID_LZ4;

typedef enum {
    /*i \dref_CompressionIdMaskBits_DDS_COMPRESSION_ID_ZLIB
     */
    DDS_COMPRESSION_ID_ZLIB_BIT = (0x0001 << 0),
    /*i \dref_CompressionIdMaskBits_DDS_COMPRESSION_ID_BZIP2
     */
    DDS_COMPRESSION_ID_BZIP2_BIT = (0x0001 << 1),
    /*i \dref_CompressionIdMaskBits_DDS_COMPRESSION_ID_LZ4
     */
    DDS_COMPRESSION_ID_LZ4_BIT = (0x0001 << 2)
} DDS_CompressionIdMaskBits;
...
struct DDS_CompressionSettings_t {
    ...
    /*e
     * \dref_CompressionSettings_t_compression_ids
     */
    DDS_CompressionIdMask compression_ids;

    /*e
     * \dref_CompressionSettings_t_writer_compression_level
     */
    DDS_UnsignedLong writer_compression_level;

    /*e
     * \dref_CompressionSettings_t_writer_compression_threshold
     */
...
struct DDS_DataRepresentationQosPolicy {
    ...
    */
    ...
    /*e \dref_DataRepresentationQosPolicy_compression_settings
     */
...
/*e \dref_COMPRESSION_ID_MASK_NONE
 */
#define DDS_COMPRESSION_ID_MASK_NONE ((DDS_CompressionIdMask) (0))

/*e \dref_COMPRESSION_ID_MASK_ALL
 */
...
/*i DDS_COMPRESSION_ID_WITH_BATCHING_SUPPORT
 * Mask with a list of the Ids of the compression algorithms that support
 * batching.
 */
#define DDS_COMPRESSION_ID_WITH_BATCHING_SUPPORT \
        ((DDS_CompressionIdMask) (DDS_COMPRESSION_ID_ZLIB_BIT))

/*e \dref_COMPRESSION_LEVEL_BEST_COMPRESSION
 */
#define DDS_COMPRESSION_LEVEL_BEST_COMPRESSION (10)

/*e \dref_COMPRESSION_LEVEL_BEST_SPEED
 */
#define DDS_COMPRESSION_LEVEL_BEST_SPEED (1)

/*e \dref_COMPRESSION_LEVEL_DEFAULT
 */
#define DDS_COMPRESSION_LEVEL_DEFAULT DDS_COMPRESSION_LEVEL_BEST_COMPRESSION

/*i COMPRESSION_LEVEL_DISABLED
 */
#define DDS_COMPRESSION_LEVEL_DISABLED (0)

/* This value will change once the performance testing is done */
/*e \dref_COMPRESSION_THRESHOLD_DEFAULT
 * This value has been decided after some performance tests, it's a prudent
 * value that will ensure, in most cases with all of the algorithms, that we are
 * going to compress the sample.
 */
#define DDS_COMPRESSION_THRESHOLD_DEFAULT 8192
/*i
 */
#define DDS_COMPRESSION_THRESHOLD_INFINITE (-1)

#define DDS_CompressionSettings_t_INITIALIZER \
    { \
...
/*i DataRepresentationQosPolicy_INITIALIZER
 */
...
/*e \dref_COMPRESSION_ID_MASK_PUBLICATION_DEFAULT
 */
#define DDS_COMPRESSION_ID_MASK_PUBLICATION_DEFAULT DDS_COMPRESSION_ID_MASK_NONE

/*e \dref_COMPRESSION_ID_MASK_SUBSCRIPTION_DEFAULT
 */
#define DDS_COMPRESSION_ID_MASK_SUBSCRIPTION_DEFAULT \
    (DDS_COMPRESSION_ID_ZLIB_BIT | DDS_COMPRESSION_ID_BZIP2_BIT \
        | DDS_COMPRESSION_ID_LZ4_BIT)

#define DDS_DATA_REPRESENTATION_QOS_POLICY_SUBSCRIPTION_DEFAULT { \
    DDS_SEQUENCE_INITIALIZER, \
    { \
...
#define DDS_DATA_REPRESENTATION_QOS_POLICY_PUBLICATION_DEFAULT { \
    DDS_SEQUENCE_INITIALIZER, \
    { \
        DDS_COMPRESSION_ID_MASK_PUBLICATION_DEFAULT, \
        DDS_COMPRESSION_LEVEL_DEFAULT, \
...
extern DDSCDllExport
struct DDS_CompressionSettings_t* DDS_CompressionSettings_copy(
        struct DDS_CompressionSettings_t* self,
        const struct DDS_CompressionSettings_t* from);

extern DDSCDllExport
DDS_Boolean DDS_DataRepresentationIdSeq_equals(
    const struct DDS_DataRepresentationIdSeq *left,
    const struct DDS_DataRepresentationIdSeq *right);
...
typedef enum DDS_SampleFlagBits {
    ...
    /*e \dref_SampleFlagBits_WRITER_REMOVED_BATCH_SAMPLE
     */
    DDS_WRITER_REMOVED_BATCH_SAMPLE = PRES_WRITER_REMOVED_BATCH_SAMPLE,
    /*e \dref_SampleFlagBits_DISCOVERY_SERVICE_SAMPLE
     */
...
struct DDS_CoherentSetInfo_t {
    /*e \dref_CoherentSetInfo_group_guid
    */
    DDS_GUID_t group_guid;
    /*e \dref_CoherentSetInfo_coherent_set_sequence_number
    */
    DDS_SequenceNumber_t coherent_set_sequence_number;
    /*e \dref_CoherentSetInfo_group_coherent_set_sequence_number
    */
    DDS_SequenceNumber_t group_coherent_set_sequence_number;
    /*e \dref_CoherentSetInfo_incomplete_coherent_set
    */
    DDS_Boolean incomplete_coherent_set;
};

 
extern DDSCDllVariable const struct DDS_CoherentSetInfo_t 
        DDS_COHERENTSETINFO_DEFAULT;
...
void DDS_Heap_free(void *ptr);
 ...
 extern DDSCDllVariable const char *const
    DDS_SNIPPET_OPTIMIZATION_RELIABILITY_PROTOCOL_KEEP_ALL;

 extern DDSCDllVariable const char *const
    DDS_SNIPPET_OPTIMIZATION_RELIABILITY_PROTOCOL_KEEP_LAST;

 extern DDSCDllVariable const char *const
    DDS_SNIPPET_OPTIMIZATION_RELIABILITY_PROTOCOL_HIGH_RATE;

 extern DDSCDllVariable const char *const
    DDS_SNIPPET_OPTIMIZATION_RELIABILITY_PROTOCOL_LOW_LATENCY;

 extern DDSCDllVariable const char *const
    DDS_SNIPPET_OPTIMIZATION_RELIABILITY_PROTOCOL_LARGE_DATA;

 extern DDSCDllVariable const char *const
    DDS_SNIPPET_OPTIMIZATION_DATACACHE_LARGE_DATA_DYNAMICMEMALLOC;
 ...
 extern DDSCDllVariable const char *const
    DDS_SNIPPET_QOS_POLICY_RELIABILITY_RELIABLE;

 extern DDSCDllVariable const char *const
    DDS_SNIPPET_QOS_POLICY_RELIABILITY_BEST_EFFORT;

 extern DDSCDllVariable const char *const
    DDS_SNIPPET_QOS_POLICY_HISTORY_KEEP_LAST_1;

 extern DDSCDllVariable const char *const
    DDS_SNIPPET_QOS_POLICY_HISTORY_KEEP_ALL;

 extern DDSCDllVariable const char *const
    DDS_SNIPPET_QOS_POLICY_PUBLISH_MODE_ASYNCHRONOUS;

 extern DDSCDllVariable const char *const
    DDS_SNIPPET_QOS_POLICY_DURABILITY_TRANSIENT_LOCAL;

 extern DDSCDllVariable const char *const
    DDS_SNIPPET_QOS_POLICY_DURABILITY_TRANSIENT;

 extern DDSCDllVariable const char *const
    DDS_SNIPPET_QOS_POLICY_DURABILITY_PERSISTENT;

 extern DDSCDllVariable const char *const
    DDS_SNIPPET_QOS_POLICY_BATCHING_ENABLE;
 ...
 extern DDSCDllVariable const char *const
    DDS_SNIPPET_TRANSPORT_TCP_LAN_CLIENT;

 extern DDSCDllVariable const char *const
    DDS_SNIPPET_TRANSPORT_TCP_WAN_SYMMETRIC_CLIENT;

 extern DDSCDllVariable const char *const
    DDS_SNIPPET_TRANSPORT_TCP_WAN_ASYMMETRIC_SERVER;

 extern DDSCDllVariable const char *const
    DDS_SNIPPET_TRANSPORT_TCP_WAN_ASYMMETRIC_CLIENT;
...
typedef enum {
    /*i Validate properties. Upon failure, log warnings and do not fail.
     */
    DDS_PROPERTY_QOS_POLICY_VALIDATION_ACTION_WARNING = -1,
    /*i Validate properties. Upon failure, log exceptions and fail.
     */
    DDS_PROPERTY_QOS_POLICY_VALIDATION_ACTION_EXCEPTION = 0,
    /*i Skip validation.
     */
    DDS_PROPERTY_QOS_POLICY_VALIDATION_ACTION_SKIP = 1,
} DDS_PropertyQosPolicyValidationAction;


#define DDS_PROPERTY_QOS_POLICY_PROPERTY_VALIDATION_ACTION_DEFAULT \
    DDS_PROPERTY_QOS_POLICY_VALIDATION_ACTION_EXCEPTION

extern DDSCDllExport
RTIBool DDS_PropertyQosPolicy_parse_property_validation_action(
        DDS_PropertyQosPolicyValidationAction *validationAction,
        const struct DDS_PropertyQosPolicy *inputProperty);

extern DDSCDllExport
RTIBool DDS_PropertyQosPolicy_validate_plugin_property_suffixes(
        const struct DDS_PropertyQosPolicy *inputProperty,
        const char *prefix,
        const char **validPublicPluginPropertySuffixes,
        const char **validPrivatePluginPropertySuffixes,
        const char *omittedPrefix,
        DDS_PropertyQosPolicyValidationAction validationAction);

struct DDS_QosPrintAll_t {
    /* Empty struct would result in a extern-c-compat warning */
    char _unused;
};
