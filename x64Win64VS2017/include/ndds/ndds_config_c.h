...
/*
 * @(#)ndds_config_c.h    generated by: makeheader    Fri Apr 23 00:06:21 2021
 *
...
#define NDDS_Config_Version_MAX_STRING_LENGTH   512
...
NDDS_Config_Version_get_core_build_number_string(void);

extern DDSCDllExport const char*
NDDS_Config_Version_get_C_build_number_string(void);
...
typedef enum {
    ...
    NDDS_CONFIG_LOG_VERBOSITY_ERROR
        = RTI_LOG_BIT_EXCEPTION | RTI_LOG_BIT_FATAL_ERROR,
...
typedef enum {
    ...
    /*e \dref_LogLevel_NDDS_CONFIG_LOG_LEVEL_FATAL_ERROR */
    NDDS_CONFIG_LOG_LEVEL_FATAL_ERROR = RTI_LOG_LEVEL_FATAL_ERROR,
...
typedef enum {
    ...
    /*e \dref_LogCategory_NDDS_CONFIG_LOG_CATEGORY_ALL
     */
...
typedef enum {
     ...
     */
    NDDS_CONFIG_LOG_PRINT_BIT_ACTIVITY_CONTEXT = ADVLOG_PRINT_BIT_ACTIVITY_CONTEXT,
     ...
     */
    NDDS_CONFIG_LOG_PRINT_BIT_BACKTRACE = RTI_LOG_PRINT_BIT_BACKTRACE,
    
    /*e \dref_LogPrintFormat_NDDS_CONFIG_LOG_PRINT_FORMAT_DEFAULT
     */
    NDDS_CONFIG_LOG_PRINT_FORMAT_DEFAULT =
        RTI_LOG_PRINT_FORMAT_MASK_DEFAULT |
        NDDS_CONFIG_LOG_PRINT_BIT_ACTIVITY_CONTEXT,
    ...
    NDDS_CONFIG_LOG_PRINT_FORMAT_DEBUG =
        RTI_LOG_PRINT_FORMAT_MASK_DEBUG |
        NDDS_CONFIG_LOG_PRINT_BIT_THREAD_ID |
        NDDS_CONFIG_LOG_PRINT_BIT_ACTIVITY_CONTEXT,
    ...
    NDDS_CONFIG_LOG_PRINT_FORMAT_MAXIMAL =
        ...
        NDDS_CONFIG_LOG_PRINT_BIT_TIMESTAMP |
        NDDS_CONFIG_LOG_PRINT_BIT_TWO_LINES |
        NDDS_CONFIG_LOG_PRINT_BIT_BACKTRACE

} NDDS_Config_LogPrintFormat;


#define NDDS_CONFIG_LOG_PRINT_FORMAT_FATAL_DEFAULT NDDS_CONFIG_LOG_PRINT_FORMAT_DEBUG
...
extern DDSCDllExport
void DDS_LoggingQoSPolicy_save(
        const struct DDS_LoggingQosPolicy *self,
        const struct DDS_LoggingQosPolicy *base,
...
extern DDSCDllExport
DDS_Boolean NDDS_Config_Logger_preinit(void);
...
typedef enum {
    /*e \dref_ActivityContextAttributeKind_NDDS_CONFIG_ACTIVITY_CONTEXT_ATTRIBUTE_GUID_PREFIX
     */
    NDDS_CONFIG_ACTIVITY_CONTEXT_ATTRIBUTE_GUID_PREFIX =
            RTI_OSAPI_ACTIVITY_CONTEXT_ATTRIBUTE_BIT_GUID_PREFIX,

    /*e \dref_ActivityContextAttributeKind_NDDS_CONFIG_ACTIVITY_CONTEXT_ATTRIBUTE_TOPIC
     */
    NDDS_CONFIG_ACTIVITY_CONTEXT_ATTRIBUTE_TOPIC =
            RTI_OSAPI_ACTIVITY_CONTEXT_ATTRIBUTE_BIT_TOPIC,

    /*e \dref_ActivityContextAttributeKind_NDDS_CONFIG_ACTIVITY_CONTEXT_ATTRIBUTE_TYPE
     */
    NDDS_CONFIG_ACTIVITY_CONTEXT_ATTRIBUTE_TYPE =
            RTI_OSAPI_ACTIVITY_CONTEXT_ATTRIBUTE_BIT_TYPE,

    /*e \dref_ActivityContextAttributeKind_NDDS_CONFIG_ACTIVITY_CONTEXT_ATTRIBUTE_ENTITY_KIND
     */
    NDDS_CONFIG_ACTIVITY_CONTEXT_ATTRIBUTE_ENTITY_KIND =
            RTI_OSAPI_ACTIVITY_CONTEXT_ATTRIBUTE_BIT_ENTITY_KIND,

    /*e \dref_ActivityContextAttributeKind_NDDS_CONFIG_ACTIVITY_CONTEXT_ATTRIBUTE_DOMAIN_ID
     */
    NDDS_CONFIG_ACTIVITY_CONTEXT_ATTRIBUTE_DOMAIN_ID =
            RTI_OSAPI_ACTIVITY_CONTEXT_ATTRIBUTE_BIT_DOMAIN_ID,

    /*e \dref_ActivityContextAttributeKind_NDDS_CONFIG_ACTIVITY_CONTEXT_ATTRIBUTE_ENTITY_NAME
     */
...
/*e \dref_ActivityContextAttributeKindMask_NDDS_CONFIG_ACTIVITY_CONTEXT_ATTRIBUTE_MASK_DEFAULT
*/
#define NDDS_CONFIG_ACTIVITY_CONTEXT_ATTRIBUTE_MASK_DEFAULT \
        RTI_OSAPI_ACTIVITY_CONTEXT_ATTRIBUTE_MASK_DEFAULT

/*e \dref_ActivityContextAttributeKindMask_NDDS_CONFIG_ACTIVITY_CONTEXT_ATTRIBUTE_MASK_NONE
*/
#define NDDS_CONFIG_ACTIVITY_CONTEXT_ATTRIBUTE_MASK_NONE \
        RTI_OSAPI_ACTIVITY_CONTEXT_ATTRIBUTE_MASK_NONE

/*e \dref_ActivityContextAttributeKindMask_NDDS_CONFIG_ACTIVITY_CONTEXT_ATTRIBUTE_MASK_ALL
*/
