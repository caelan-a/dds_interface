...
#define RTIXCdrStream_setEncapsulationOptionsCompressionId( \
        __me, \
        __compressionId) \
    ((__me)->_encapsulationOptions = \
            (RTIXCdrEncapsulationOptions) \
                    ((((__me)->_encapsulationOptions & ~(7 << 2)) \
                            | (((__compressionId) & 7) << 2)))) \

#define RTIXCdrStream_getEncapsulationOptionsCompressionId(__me) \
    (((__me)->_encapsulationOptions >> 2) & 7)

#define RTIXCdrStream_setEncapsulationOptionsNumPaddingBytes( \
        __me, \
        numPaddingBytes) \
    ((__me)->_encapsulationOptions = ((me->_encapsulationOptions & ~(3)) \
            | ((numPaddingBytes) & 3)))

#define RTIXCdrStream_getEncapsulationOptionsNumPaddingBytes(__me) \
        ((RTIXCdrOctet)((__me)->_encapsulationOptions & 3))
...
#define RTIXCdrEncapsulationOptions_pack( \
        ...
        __numPaddingBytes) \
    (*(__options) = \
            (RTIXCdrEncapsulationOptions)((((__compressionId) & 7) << 2) \
                    | ((__numPaddingBytes) & 3)))
...
#define RTIXCdrEncapsulationOptions_unpack( \
        ...
        __compressionId, \
        __numPaddingBytes) \
    (*(__compressionId) = (((__options) >> 2) & 7)); \
    (*(__numPaddingBytes) = (RTIXCdrOctet)((__options) & 3))
