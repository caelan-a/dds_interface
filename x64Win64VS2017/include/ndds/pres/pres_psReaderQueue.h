...
/*
 * @(#)pres_psReaderQueue.h    generated by: makeheader    Fri Apr 23 00:10:20 2021
 *
...
struct PRESPsReaderQueueProperty {
     ...
     * NotAliveNoWriters sample when all active writers are gone.
     */
...
PRESPsReaderQueue_hasOutstandingLoans(struct PRESPsReaderQueue *me);
...
PRESPsReaderQueueRemoteWriterQueue_getNode(
...
extern PRESDllExport
RTIBool PRESPsReaderQueue_addSample(
        struct PRESPsReaderQueue *me,
...
extern PRESDllExport
RTIBool PRESPsReaderQueue_pruneAndUpdate(
        struct PRESPsReaderQueue *me,
        const struct RTINtpTime *now,
