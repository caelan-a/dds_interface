...
/*
 * @(#)pres_common.h    generated by: makeheader    Fri Apr 23 00:10:13 2021
 *
...
#define PRES_PARTICIPANT_DOMAIN_TAG_PROPERTY_NAME PROPERTY_NAME_DDS_DOMAIN_PARTICIPANT_DOMAIN_TAG


#define PRES_PARTICIPANT_DISCOVERY_INITIAL_PARTICIPANT_ANNOUNCEMENTS_ON_ENABLE_PROPERTY PROPERTY_NAME_DDS_PARTICIPANT_DISCOVERY_CONFIG_INITIAL_PARTICIPANT_ANNOUNCEMENTS_ON_ENABLE
#define PRES_PARTICIPANT_DISCOVERY_USE_STATELESS_PARTICIPANT_DISCOVERY_READER_PROPERTY_NAME PROPERTY_NAME_DDS_PARTICIPANT_DISCOVERY_CONFIG_USE_STATELESS_PARTICIPANT_DISCOVERY_READER
#define PRES_PARTICIPANT_DISCOVERY_DISABLE_SIGNATURE_VALIDATION_PROPERTY_NAME PROPERTY_NAME_DDS_PARTICIPANT_DISCOVERY_CONFIG_DISABLE_SIGNATURE_VALIDATION
#define PRES_PARTICIPANT_DISCOVERY_DISABLE_SECURE_PARTICIPANT_DISCOVERY_PROPERTY_NAME PROPERTY_NAME_DDS_PARTICIPANT_DISCOVERY_CONFIG_DISABLE_SECURE_PARTICIPANT_DISCOVERY
#define PRES_PARTICIPANT_DISCOVERY_DISABLE_RECEIVED_DISCOVERY_PROTECTION_NAME PROPERTY_NAME_DDS_PARTICIPANT_DISCOVERY_CONFIG_DISABLE_RECEIVED_DISCOVERY_PROTECTION
#define PRES_PARTICIPANT_DISCOVERY_DISABLE_RTI_ENDPOINT_SECURITY_ATTRIBUTES_PROPAGATION_NAME PROPERTY_NAME_DDS_PARTICIPANT_DISCOVERY_CONFIG_DISABLE_RTI_ENDPOINT_SECURITY_ATTRIBUTES_PROPAGATION
#define PRES_PARTICIPANT_DISCOVERY_DISABLE_ENDPOINT_SECURITY_INFO_PROPAGATION_NAME PROPERTY_NAME_DDS_PARTICIPANT_DISCOVERY_CONFIG_DISABLE_ENDPOINT_SECURITY_INFO_PROPAGATION
#define PRES_PARTICIPANT_DISCOVERY_DISABLE_PARTICIPANT_SECURITY_INFO_PROPAGATION_NAME PROPERTY_NAME_DDS_PARTICIPANT_DISCOVERY_CONFIG_DISABLE_PARTICIPANT_SECURITY_INFO_PROPAGATION
#define PRES_PARTICIPANT_DISCOVERY_DISABLE_PARTICIPANT_SECURITY_INFO_VALIDATION_NAME PROPERTY_NAME_DDS_PARTICIPANT_DISCOVERY_CONFIG_DISABLE_PARTICIPANT_SECURITY_INFO_VALIDATION
#define PRES_PARTICIPANT_DISCOVERY_ENABLE_FRAGMENTATION_PROPERTY PROPERTY_NAME_DDS_PARTICIPANT_DISCOVERY_CONFIG_ENABLE_FRAGMENTATION



#define PRES_PARTICIPANT_DISCOVERY_ENDPOINT_TYPE_OBJECT_LB_SERIALIZATION_THRESHOLD_PROPERTY_NAME \
    PROPERTY_NAME_DDS_PARTICIPANT_DISCOVERY_CONFIG_ENDPOINT_TYPE_OBJECT_LB_SERIALIZATION_THRESHOLD
#define PRES_PARTICIPANT_DISCOVERY_ENDPOINT_TYPE_OBJECT_LB_SERIALIZATION_ALGORITHM_PROPERTY_NAME \
    PROPERTY_NAME_DDS_PARTICIPANT_DISCOVERY_CONFIG_ENDPOINT_TYPE_OBJECT_LB_SERIALIZATION_ALGORITHM


#define PRES_PARTICIPANT_DISCOVERY_SEND_PARTICIPANT_ANNOUNCEMENT_ON_DISCOVERY_PROPERTY PROPERTY_NAME_DDS_PARTICIPANT_INTER_PARTICIPANT_DATA_WRITER_PROTOCOL_SEND_PARTICIPANT_ANNOUNCEMENT_ON_DISCOVERY
#define PRES_PARTICIPANT_DISCOVERY_BROADCAST_PARTICIPANT_ANNOUNCEMENT_ON_DISCOVERY_PROPERTY PROPERTY_NAME_DDS_PARTICIPANT_INTER_PARTICIPANT_DATA_WRITER_PROTOCOL_BROADCAST_PARTICIPANT_ANNOUNCEMENT_ON_DISCOVERY
#define PRES_INTER_PARTICIPANT_DISABLE_PREEMPTIVE_NACK_PROPERTY PROPERTY_NAME_DDS_PARTICIPANT_INTER_PARTICIPANT_DATA_READER_PROTOCOL_DISABLE_PREEMPTIVE_NACK
#define PRES_INTER_PARTICIPANT_DISABLE_PREEMPTIVE_HEARTBEAT_PROPERTY PROPERTY_NAME_DDS_PARTICIPANT_INTER_PARTICIPANT_DATA_WRITER_PROTOCOL_DISABLE_PREEMPTIVE_HEARTBEAT
#define PRES_PARTICIPANT_DISABLE_PREEMPTIVE_HEARTBEAT_PROPERTY PROPERTY_NAME_DDS_PARTICIPANT_BUILTIN_DATA_WRITER_PROTOCOL_DISABLE_PREEMPTIVE_HEARTBEAT
#define PRES_PARTICIPANT_BUILTIN_DATA_WRITER_PROTOCOL_DISABLE_REPAIR_PIGGYBACK_HEARTBEAT \
    PROPERTY_NAME_DDS_PARTICIPANT_BUILTIN_DATA_WRITER_PROTOCOL_DISABLE_REPAIR_PIGGYBACK_HEARTBEAT

#define PRES_DISCOVERY_ENABLE_RTPS_DISCOVERY_OPTIMIZATION_DEFAULT (RTI_FALSE)
...
#define PRES_AUTO_WRITER_DEPTH 0
...
typedef RTI_UINT32 PRESCompressionIdMask;
...
typedef enum {
    PRES_COMPRESSION_ID_ZLIB = (0x0001 << 0),
    PRES_COMPRESSION_ID_BZIP2 = (0x0001 << 1),
    PRES_COMPRESSION_ID_LZ4 = (0x0001 << 2)
} PRESCompressionIdMaskBits;

#define PRES_COMPRESSION_ID_NONE 0
#define PRES_COMPRESSION_ID_ALL \
        PRES_COMPRESSION_ID_ZLIB | PRES_COMPRESSION_ID_BZIP2 \
                | PRES_COMPRESSION_ID_LZ4

struct PRESCompressionSettings {
    /*e
     * Compression algorithms enabled.
     */
    PRESCompressionIdMask compressionIds;
    /*e
     * Compression level to apply to the payload.
     */
    RTI_UINT32 writerCompressionLevel;
    /*e
     * Threshold from which a payload with bigger size will be compressed.
     */
    RTI_INT32 writerCompressionThreshold;
};
...
struct PRESDataRepresentationQosPolicy {
     ...
     */
    struct PRESCompressionSettings compressionSettings;
};



#define PRES_COMPRESSION_THRESHOLD_INFINITE -1

#define PRES_DATA_REPRESENTATION_VALUE_DEFAULT \
    { \
        PRES_MAX_DATA_REPRESENTATION_VALUES, \
        0, \
        {0} /* _buffer */ \
...
#define PRES_COMPRESSION_IDS_DEFAULT \
    (PRESCompressionIdMask)(PRES_COMPRESSION_ID_NONE)

#define PRES_COMPRESSION_SETTINGS_DEFAULT \
    { \
        PRES_COMPRESSION_IDS_DEFAULT, /* bitmask */ \
        RTI_OSAPI_COMPRESSION_LEVEL_BEST_COMPRESSION /* compression level */, \
        8192  /* compression threshold */ \
    }

#define PRES_DATA_REPRESENTATION_QOS_POLICY_DEFAULT \
    { \
        PRES_DATA_REPRESENTATION_VALUE_DEFAULT, \
        PRES_COMPRESSION_SETTINGS_DEFAULT \
    }
...
extern	PRESDllExport
RTIOsapiCompressionPluginClassId PRESCompressionId_toOsapiCompressionPluginId(
        PRESCompressionIdMaskBits compressionId);
...
struct PRESDurabilityQosPolicy {
    ...
    /*e
     * Writer depth 
     * Number of samples a durable DataWriter will send to a late joining 
     * DataReader. This configuration will be ignored at the DataReader.
     */
    RTI_INT32 writerDepth;
};
  ...
  #define PRES_DURABILITY_QOS_POLICY_DEFAULT { \
    ...
    PRES_AUTO_WRITER_DEPTH /* writerDepth */ \
  }
...
struct PRESPresentationQosPolicy {
    ...
    /*e
      Indicates if samples from incomplete coherent sets are dropped
     */
    RTIBool dropIncompleteCoherentSet;
};


#define PRES_PRESENTATION_QOS_POLICY_DEFAULT { \
    PRES_INSTANCE_PRESENTATION_QOS, \
    RTI_FALSE, \
    RTI_FALSE, \
    RTI_TRUE \
...
struct PRESHistoryQosPolicy {
  ...
  #define PRES_HISTORY_QOS_POLICY_DEFAULT {PRES_KEEP_LAST_HISTORY_QOS, 1}
...
struct PRESWriterDataLifecycleQosPolicy {
  ...
  #define PRES_WRITER_DATA_LIFECYCLE_QOS_POLICY_DEFAULT { \
    RTI_FALSE,        /* autodisposeUnregisteredInstances */ \
...
struct PRESReaderDataLifecycleQosPolicy {
    ...
    /*e
     * Minimum duration for which the DataReader will maintain an instance
     * once there are no writers for it.
     */
    struct RTINtpTime autopurgeNowriterInstancesDelay;
};
  ...
  #define PRES_READER_DATA_LIFECYCLE_QOS_POLICY_DEFAULT { \
    ...
    RTI_NTP_TIME_MAX, /*autopurgeDisposedInstancesDelay*/ \
    RTI_NTP_TIME_ZERO /*autopurgeNowriterInstancesDelay*/ \
    }
...
typedef enum {
     ...
     * Not used. We keep it because it is in the spec.
     */
    PRES_REJECTED_BY_INSTANCES_LIMIT,
    /*e
     * When using "Reliable" reliability:
     * Sample is rejected because sample limit is exceeded.
     */
    PRES_REJECTED_BY_SAMPLES_LIMIT,
    /*e
     * When using "Reliable" reliability:
    ...
    /*e
     * When using "Reliable" reliability:
     * Sample is rejected because the sample cannot be decoded.
     */
    PRES_REJECTED_BY_DECODE_FAILURE
...
typedef enum {
    ...
    /*e
     * Sample is lost because remote writers per instance limit is exceeded.
     */
    ...
    /*e
     * Sample is lost because it is part of a large coherent set.
     */
    ...
    /*e
     * Sample is lost because it cannot be deserialized.
     */
    PRES_LOST_BY_DESERIALIZATION_FAILURE,
    /*e
     * When using "Best Effort" reliability:
     * Sample is lost because it cannot be decoded.
     */
    PRES_LOST_BY_DECODE_FAILURE,
    /*e
     * When using "Best Effort" reliability:
     * Sample is lost because sample per instance limit is exceeded.
    */
    PRES_LOST_BY_SAMPLES_PER_INSTANCE_LIMIT,
    /*e
     * When using "Best Effort" reliability:
     * Sample is lost because sample limit is exceeded.
     */
    PRES_LOST_BY_SAMPLES_LIMIT
...
struct PRESPublicationReliableQueueStatus {
    ...
    */
    ...
    /*e
      The total number of unacknowledged samples replaced in the reliable writer
      queue due to KEEP_LAST history depth limit.
     */
    RTI_INT64 replacedUnacknowledgedSampleCount;
};
...
struct PRESGroup {
    ...
    */
     ...
     */
     ...
     /*  When PresentationQosPolicy is set to GROUP this sequence number 
      *  contains the sequence number that identifies the group coherent set
      *  after beginCoherentSet is called
      */    
     struct REDASequenceNumber _groupCoherentSetSn;
...
#define PRES_TYPE_CONSISTENCY_ENFORCEMENT_QOS_DEFAULT { \
    PRES_ALLOW_TYPE_COERCION, \
    RTI_CDR_BOOLEAN_TRUE, /* ignoreSequenceBounds */ \
    RTI_CDR_BOOLEAN_TRUE, /* ignoreStringBounds */ \
...
#define PRES_TOPIC_PROPERTY_DEFAULT {                               \
  { /* immutable_part */ \
   ...
   { /* durabilityServiceQosPolicy */ \
       ...
       PRES_HISTORY_QOS_POLICY_DEFAULT, /* history */ \
       { /* resourceLimits */ \
...
extern PRESDllExport
void * PRESContentFilterSQLCompile(
        RTI_UINT32 systemKey,
        void *handle,
...
extern PRESDllExport
RTI_INT32 PRESContentFilterSQLEvaluate(
        RTI_UINT32 systemKey,
        void *filter_object,
        void *handle,
        const void *sample,
        const struct PRESFilterSampleInfo* meta_data);

extern PRESDllExport
RTI_INT32 PRESContentFilterSQLEvaluateOnSerialized(
        RTI_UINT32 systemKey,
        void *filter_object,
        void *handle,
        const void *sample,
...
extern PRESDllExport
void PRESContentFilterSQLFinalize(
        RTI_UINT32 systemKey,
        void *filter_object,
        void *handle);

extern PRESDllExport
RTI_INT32 PRESContentFilterSQLQuery(
        RTI_UINT32 systemKey,
        void* filter_object,
        void* handle);
...
/*e \ingroup PRESParticipantModule
 * Force the endpoint locator count to be 0, regardless of the parent
 * participant's locators
 */
  #define PRES_LOCATOR_QOS_POLICY_COUNT_FORCE_ZERO -1
...
#define PRESProductVersion MIGRtpsProductVersion


#define PRESProductVersion_INITIALIZER MIGRtpsProductVersion_INITIALIZER



#define PRES_PRODUCT_VERSION_INVALID_INITIALIZER \
    MIG_RTPS_PRODUCT_VERSION_INVALID_INITIALIZER

#define PRES_PRODUCT_VERSION_DEFAULT MIG_RTPS_PRODUCT_VERSION_DEFAULT
...
#define PRES_PRODUCT_VERSION_MAJOR_DIRECTED_WRITE_NATIVE (6)
#define PRES_PRODUCT_VERSION_MINOR_DIRECTED_WRITE_NATIVE (1)
#define PRES_PRODUCT_VERSION_RELEASE_DIRECTED_WRITE_NATIVE (0)
#define PRES_PRODUCT_VERSION_REVISION_DIRECTED_WRITE_NATIVE (0)

#define PRES_PRODUCT_VERSION_DIRECTED_WRITE_NATIVE { \
  PRES_PRODUCT_VERSION_MAJOR_DIRECTED_WRITE_NATIVE, \
  PRES_PRODUCT_VERSION_MINOR_DIRECTED_WRITE_NATIVE, \
  PRES_PRODUCT_VERSION_RELEASE_DIRECTED_WRITE_NATIVE, \
  PRES_PRODUCT_VERSION_REVISION_DIRECTED_WRITE_NATIVE \
}

extern int PRESProductVersion_compare(const void* l, const void* r);

extern PRESDllExport
RTIBool PRESProductVersion_fromString(
        struct PRESProductVersion *out,
        const char *in);
...
#define PRES_BUILTIN_ENDPOINT_CDS_ANNOUNCER_WRITER \
    MIG_RTPS_VENDOR_BUILTIN_ENDPOINT_CDS_ANNOUNCER_WRITER
...
typedef enum PRESSampleFlagBits {
    ...
    PRES_WRITER_REMOVED_BATCH_SAMPLE = (1 << 5),
    PRES_DISCOVERY_SERVICE_SAMPLE = (1 << 6)
} PRESSampleFlagBits;
...
struct PRESWriteParams {
    ...
    /**
     *  The product version is here so that it can be propagated to the writer
     *  and used when serializing the GUID for directed writes.
     */
    struct PRESProductVersion relatedReaderProductVersion;
...
#define PRES_WRITE_PARAMS_DEFAULT {  \
    ...
    MIG_RTPS_GUID_UNKNOWN, \
    MIG_RTPS_GUID_UNKNOWN, \
    PRES_PRODUCT_VERSION_INVALID_INITIALIZER, \
    NULL, \
...
#define PRES_TRANSPORT_ENCAPSULATION_PROPERTY_DEFAULT { \
    RTI_FALSE, /* applyEncapsulationsToAllPlugins */ \
    NULL, /* plugin */ \
    NDDS_TRANSPORT_ADDRESS_INVALID_INITIALIZER, /* address */ \
    0, /* encapsulationCount */ \
    NETIO_LOCATOR_ENCAPSULATION_ARRAY_INVALID /* encapsulations */ \
}
...
typedef enum {
    /*i \ingroup PRESPsServiceModule
     *\brief No instances will be removed
     */
    PRES_NO_INSTANCE_REMOVAL = 0,
    /*i \ingroup PRESPsServiceModule
     *\brief Only empty instances will be removed
     */
    PRES_EMPTY_INSTANCE_REMOVAL = 1,
    /*i \ingroup PRESPsServiceModule
     *\brief Only fully processed instances will be removed
     */
    PRES_FULLY_PROCESSED_INSTANCE_REMOVAL = 2,
    /*i \ingroup PRESPsServiceModule
     *\brief Any instance will be removed
     */
    PRES_ANY_INSTANCE_REMOVAL = 3
} PRESDataReaderInstanceRemovalKind;

typedef struct PRESDataReaderResourceLimitsInstanceReplacementSettings {
    PRESDataReaderInstanceRemovalKind alive_instance_removal;
    PRESDataReaderInstanceRemovalKind disposed_instance_removal;
    PRESDataReaderInstanceRemovalKind no_writers_instance_removal;
} PRESDataReaderResourceLimitsInstanceReplacementSettings;


#define PRESPsReaderDataReaderResourceLimitsInstanceReplacementSettings_INITIALIZER { \
        PRES_NO_INSTANCE_REMOVAL, /* alive_instance_removal */ \
        PRES_EMPTY_INSTANCE_REMOVAL, /* disposed_instance_removal */ \
        PRES_EMPTY_INSTANCE_REMOVAL /* no_writers_instance_removal */ \
    }
 ...
 */
#define PRES_TRUST_LOGGING_SILENT_LEVEL       -1
...
(*PRESBuiltinChannelForwarderTransformCdrFromPresFunction)(
        ...
        struct PRESRtpsContext *rtpsContext);
...
struct PRESCoherentSetInfo {
    struct PRESOctetGuid groupGuid;
    struct REDASequenceNumber coherentSetSequenceNumber;
    struct REDASequenceNumber groupCoherentSetSequenceNumber;
    /* This type is a char and not an RTIBool (4-byte) because the format has 
     * to match the one in DDS_C where incompleteCoherentSet is a DDS_Boolean 
     * (1-byte).
     */
    char incompleteCoherentSet;
};


#define PRES_COHERENT_SET_INFO_DEFAULT { \
    PRES_OCTET_GUID_UNKNOWN, \
...
extern PRESDllExport
RTIBool PRESCoherentSetInfo_equal(
   const struct PRESCoherentSetInfo *leftValue, 
   const struct PRESCoherentSetInfo *rightValue);


/*
 * These two preprocessor definitions are used to limit the number of nodes in
 * the skip list of instances and virtual writers.
 */
#define PRES_ENDPOINT_EXPECTED_MAX_INSTANCE_COUNT \
    NDDS_WRITER_HISTORY_EXPECTED_MAX_INSTANCE_COUNT
#define PRES_ENDPOINT_EXPECTED_MAX_VIRTUAL_WRITERS_COUNT \
    NDDS_WRITER_HISTORY_EXPECTED_MAX_VIRTUAL_WRITERS_COUNT
