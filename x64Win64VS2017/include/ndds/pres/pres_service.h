...
/*
 * @(#)pres_service.h    generated by: makeheader    Fri Apr 23 00:10:24 2021
 *
...
typedef RTIBool (*PRESPsServiceRemoteEndpointsUpdateUnicastLocatorsFunction)(
...
typedef RTIBool (*PRESServiceLocalEndpointPropertySetFunction)(
        ...
        int *failReason,
        struct PRESLocalEndpoint *endpoint,
        const struct PRESLocalEndpointProperty *p,
        RTIBool propagateThroughDiscovery,
        struct REDAWorker *worker);
...
struct PRESService {
    ...
    PRESPsServiceRemoteEndpointsUpdateUnicastLocatorsFunction 
        updateRemoteEndpointsUnicastLocators;
