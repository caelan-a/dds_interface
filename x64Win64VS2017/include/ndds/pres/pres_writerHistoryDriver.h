...
/*
 * @(#)pres_writerHistoryDriver.h    generated by: makeheader    Fri Apr 23 00:10:26 2021
 *
...
#define PRES_WRITER_ALLOW_OUT_OF_ORDER_WRITE_PROPERTY PROPERTY_NAME_DDS_DATA_WRITER_HISTORY_ALLOW_OUT_OF_ORDER_WRITE
#define PRES_WRITER_DISABLE_INLINE_KEYHASH_IN_DISPOSE_PROPERTY PROPERTY_NAME_DDS_DATA_WRITER_PROTOCOL_DISABLE_INLINE_KEYHASH_IN_DISPOSE
#define PRES_WRITER_DISABLE_SERIALIZE_KEY_IN_DOSPOSE_PROPERTY PROPERTY_NAME_DDS_DATA_WRITER_PROTOCOL_DISABLE_SERIALIZE_KEY_IN_DISPOSE
#define PRES_WRITER_SEND_MULTICAST_PERIODIC_HEARTBEATS_PROPERTY PROPERTY_NAME_DDS_DATA_WRITER_PROTOCOL_SEND_MULTICAST_PERIODIC_HEARTBEATS
#define PRES_WRITER_MULTICAST_REPAIR_THRESHOLD_PROPERTY PROPERTY_NAME_DDS_DATA_WRITER_PROTOCOL_MULTICAST_REPAIR_THRESHOLD

/*** begin turbo mode properties ***/
/* document this property */
#define PRES_WRITER_TURBO_MODE_PROPERTY PROPERTY_NAME_DDS_DATA_WRITER_ENABLE_TURBO_MODE

/* don't document these properties */
#define PRES_WRITER_TURBO_MODE_MAX_DATA_BYTES_PROPERTY PROPERTY_NAME_DDS_DATA_WRITER_TURBO_MODE_MAX_DATA_BYTES
#define PRES_WRITER_TURBO_MODE_MAX_META_DATA_BYTES_PROPERTY PROPERTY_NAME_DDS_DATA_WRITER_TURBO_MODE_MAX_META_DATA_BYTES
#define PRES_WRITER_TURBO_MODE_MAX_FLUSH_DELAY_MICROSEC_PROPERTY PROPERTY_NAME_DDS_DATA_WRITER_TURBO_MODE_MAX_FLUSH_DELAY_MICROSEC
#define PRES_WRITER_TURBO_MODE_SAMPLES_PER_REEVALUATION_PROPERTY PROPERTY_NAME_DDS_DATA_WRITER_TURBO_MODE_SAMPLES_PER_REEVALUATION
#define PRES_WRITER_TURBO_MODE_FREQUENCY_MIN_PROPERTY PROPERTY_NAME_DDS_DATA_WRITER_TURBO_MODE_FREQUENCY_MIN
#define PRES_WRITER_TURBO_MODE_FREQUENCY_MAX_PROPERTY PROPERTY_NAME_DDS_DATA_WRITER_TURBO_MODE_FREQUENCY_MAX
...
#define PRES_INTER_PARTICIPANT_DISABLE_INLINE_KEYHASH_PROPERTY PROPERTY_NAME_DDS_PARTICIPANT_INTER_PARTICIPANT_DATA_WRITER_PROTOCOL_DISABLE_INLINE_KEYHASH
#define PRES_INTER_PARTICIPANT_DISABLE_INLINE_KEYHASH_IN_DISPOSE_PROPERTY PROPERTY_NAME_DDS_PARTICIPANT_INTER_PARTICIPANT_DATA_WRITER_PROTOCOL_DISABLE_INLINE_KEYHASH_IN_DISPOSE
#define PRES_INTER_PARTICIPANT_DISABLE_SERIALIZE_KEY_IN_DOSPOSE_PROPERTY PROPERTY_NAME_DDS_PARTICIPANT_INTER_PARTICIPANT_DATA_WRITER_PROTOCOL_DISABLE_SERIALIZE_KEY_IN_DISPOSE

#define PRES_PARTICIPANT_DISCOVERY_DISABLE_INLINE_KEYHASH_PROPERTY PROPERTY_NAME_DDS_PARTICIPANT_DISCOVERY_DATA_WRITER_PROTOCOL_DISABLE_INLINE_KEYHASH
#define PRES_PARTICIPANT_DISCOVERY_DISABLE_INLINE_KEYHASH_IN_DISPOSE_PROPERTY PROPERTY_NAME_DDS_PARTICIPANT_DISCOVERY_DATA_WRITER_PROTOCOL_DISABLE_INLINE_KEYHASH_IN_DISPOSE
#define PRES_PARTICIPANT_DISCOVERY_DISABLE_SERIALIZE_KEY_IN_DOSPOSE_PROPERTY PROPERTY_NAME_DDS_PARTICIPANT_DISCOVERY_DATA_WRITER_PROTOCOL_DISABLE_SERIALIZE_KEY_IN_DISPOSE

#define PRES_WRITER_HISTORY_LOCAL_DURABILITY_PROPERTY PROPERTY_NAME_DDS_DATA_WRITER_HISTORY_LOCAL_DURABILITY

#define PRES_WRITER_HISTORY_KEY_MATERIAL_KEY_PROPERTY PROPERTY_NAME_DDS_DATA_WRITER_HISTORY_KEY_MATERIAL_KEY

#define PRES_WRITER_HISTORY_ENDIANNESS_PROPERTY PROPERTY_NAME_DDS_DATA_WRITER_HISTORY_ENDIANNESS

#define PRES_WRITER_KEEP_READER_APPACK_STATE_PROPERTY PROPERTY_NAME_DDS_DATA_WRITER_PROTOCOL_KEEP_READER_APPACK_STATE

#define PRES_WRITER_HISTORY_SOURCE_TIMESTAMP_BASED_AUTOPURGE_PROPERTY PROPERTY_NAME_DDS_DATA_WRITER_HISTORY_SOURCE_TIMESTAMP_BASED_AUTOPURGE_INSTANCES_DELAY

#define PRES_WRITER_HISTORY_USE_530_ENCODING_ALIGNMENT_PROPERTY PROPERTY_NAME_DDS_DATA_WRITER_HISTORY_USE_530_ENCODING_ALIGNMENT

#define PRES_WRITER_HISTORY_DURABILITY_DEPTH_PROPERTY "test.dds.data_writer.history.durability_depth"
...
struct PRESWriterHistoryDriverProperty {
    ...
    */
    ...
    /*e Temporary setting until applied in durabilityQos::durability writer depth */
    int durabilityWriterDepth;
    ...
    */
    ...
    /*
     * Compression plugin based on the compression settings from
     * DataRepresentationQosPolicy
     */
    RTIOsapiCompressionPlugin *compressionPlugin;
    /*
     * For Testing only: Whenever compression is enabled this will force to
     * compress the sample or batch regardless the size of the
     * maxSerializedSampleSize or maxSamplesPerBatch. This is useful when we
     * want to compress data that it's to small to be compressed without a final
     * data expansion (The compressed data would be bigger than the input).
     */
    RTIBool enforceCompression;
  ...
  #define PRES_WRITER_HISTORY_DRIVER_PROPERTY_DEFAULT { \
    ...
    {RTI_NTP_TIME_MAX},                               \
    PRES_HISTORY_QOS_POLICY_DEFAULT,\
    ...
    -1, /* maxVirtualWriters */ \
    PRES_PRESENTATION_QOS_POLICY_DEFAULT, /* presentationQos */ \
    ...
    0, /* nonce */ \
    PRES_COMPRESSION_SETTINGS_DEFAULT, /* compressionSettings */ \
    NULL, /* compressionPlugin */ \
    RTI_FALSE, /* enforceCompression */ \
    NULL, /* topicName */ \
    NULL /* typeName */ \
   }
...
PRESWriterHistoryDriver_invalidateIndex(
...
PRESWriterHistoryDriver_addHistorical(
    ...
    const struct RTINtpTime *now,
    RTIBool ignoreSendWindow,
    struct PRESParticipant *presParticipant,
    struct REDAWorker *worker);
...
extern PRESDllExport void
PRESWriterHistoryDriver_beginCoherentChanges(
        struct PRESWriterHistoryDriver *me,
        const struct REDASequenceNumber *groupCoherentSetSn);
...
extern PRESDllExport RTIBool
PRESWriterHistoryDriver_getFirstAvailableSn(
    struct PRESWriterHistoryDriver *me,
    struct REDASequenceNumber *firstAvailableSn,
    struct REDASequenceNumber *firstAvailableVirtualSn,
    RTI_INT32 sessionCount, 
    const RTI_INT32 *sessionId,
    struct REDAWorker *worker);
...
extern	PRESDllExport RTIBool PRESWriterHistoryDriver_serializeSample(
        struct PRESWriterHistoryDriver* me,
        struct REDABuffer* buffer,
        PRESSampleHash *sampleHash,
        struct MIGGeneratorSample* sample,
        RTIEncapsulationId encapsulationId,
        RTIBool plainSerializedData);
