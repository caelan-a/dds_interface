...
/*
 * @(#)pres_cstReaderCollator.h    generated by: makeheader    Fri Apr 23 00:10:13 2021
 *
...
#define PRES_CST_READER_COLLATOR_EFFECTIVE_ORDERED_ACCESS_PROPERTY PROPERTY_NAME_DDS_DATA_READER_QUEUE_EFFECTIVE_ORDERED_ACCESS
#define PRES_CST_READER_COLLATOR_EFFECTIVE_ACCESS_SCOPE_PROPERTY PROPERTY_NAME_DDS_DATA_READER_QUEUE_EFFECTIVE_ACCESS_SCOPE
...
struct PRESCstReaderCollatorProperty {
     ...
     * Max bound limited by DataReader resource limits::max_instances
     * rwReader->_resourceLimitsQosPolicy.instanceCount.maximal
     */
    struct REDAFastBufferPoolGrowthProperty registeredInstanceCount;
    /*
     * Max bound limited by DataReader resource limits::max_total_instances
     * rwReader->_resourceLimitsQosPolicy.maxTotalInstances
     */
    ...
    /* 
     * Configures how instances should be replaced when the max_instances
     * resource limit is hit.
     */
    struct PRESDataReaderResourceLimitsInstanceReplacementSettings instanceReplacementSettings;
    ...
    /*
     * If the value of acceptWriterRemovedBatchSamples is true the flag
     * 'MIG_RTPS_DATA_BATCH_SAMPLE_INFO_I_FLAG' will be ignored.
     * This flag indicates that a sample was marked as removed by the DataWriter,
     * for example when a sample is replaced because of KEEP_LAST history depth.
     */
    RTIBool acceptWriterRemovedBatchSamples;

    /*
     * If the DataReader receives a batch with samples marked as removed
     * and logWriterRemovedBatchSamples is true:
     * - A message with this information is logged.
     */
    RTIBool logWriterRemovedBatchSamples;

    /*
     * When this property is FALSE, the queue will not generate a 
     * NotAliveNoWriters sample for instances that transition to
     * NOT_ALIVE_NO_WRITERS_STATE
     */
    RTIBool generateNotAliveNoWritersSample;
};
...
#define PRES_CST_READER_COLLATOR_PROPERTY_DEFAULT {      \
    ...
    {PRES_TOPIC_PRESENTATION_QOS,RTI_FALSE,RTI_TRUE, RTI_TRUE},      \
    {RTI_NTP_TIME_MAX},                                    \
    ...
    {PRES_VOLATILE_DURABILITY_QOS,RTI_TRUE,PRES_AUTO_WRITER_DEPTH}, /* durability qos policy */\
    ...
    PRESPsReaderDataReaderResourceLimitsInstanceReplacementSettings_INITIALIZER, /* instanceReplacementPolicy */\
    ...
    NULL, /* topicName */ \
    NULL, /* typeName */ \
    PRES_READER_ACCEPT_WRITER_REMOVED_BATCH_SAMPLES_DEFAULT, /* acceptWriterRemovedBatchSamples */ \
    PRES_READER_LOG_WRITER_REMOVED_BATCH_SAMPLES_DEFAULT, /* logWriterRemovedBatchSamples */ \
    RTI_TRUE /* generateNotAliveNoWritersSample */ \
}
...
PRESCstReaderCollator_newAnonData(
    ...
    RTI_UINT32 *readConditionState,
    struct PRESPsService_QueryConditionState *queryConditionState,
    const struct PRESParticipant *presParticipant,
    struct REDAWorker *worker);
...
extern PRESDllExport
RTIBool PRESCstReaderCollator_pruneAndUpdate(
        struct PRESCstReaderCollator *me,
        const struct RTINtpTime *now,
...
extern PRESDllExport
void PRESCstReaderCollator_getStatistics(
        struct PRESCstReaderCollator *me,
