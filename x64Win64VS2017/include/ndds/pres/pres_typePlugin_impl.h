...
/*
 * @(#)pres_typePlugin_impl.h    generated by: makeheader    Fri Apr 23 00:10:26 2021
 *
...
#define PRES_TYPE_PLUGIN_ACCEPT_UNKNOWN_ENUM_VALUE PROPERTY_NAME_DDS_SAMPLE_ASSIGNABILITY_ACCEPT_UNKNOWN_ENUM_VALUE
#define PRES_TYPE_PLUGIN_ACCEPT_UNKNOWN_UNION_DISCRIMINATOR PROPERTY_NAME_DDS_SAMPLE_ASSIGNABILITY_ACCEPT_UNKNOWN_UNION_DISCRIMINATOR
 ...
 * serialized key.
 */
#define PRES_TYPE_PLUGIN_FORCE_MD5_KEYHASH PROPERTY_NAME_DDS_TYPE_PLUGIN_FORCE_MD5_KEYHASH
...
#define PRESTypePluginDefaultEndpointData_isCompressionEnabled(epd) \
    ((struct PRESTypePluginDefaultEndpointData *) epd)->_compressionEnabled
...
#define PRESTypePluginDefaultEndpointData_getInUseWriterLoanedSamplesCount(epd) \
    REDAInlineList_getSize( \
            ((struct PRESTypePluginDefaultEndpointData *)epd)->_pool->inUseWriterLoanedSamples)
