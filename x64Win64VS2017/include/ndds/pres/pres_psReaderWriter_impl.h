...
/*
 * @(#)pres_psReaderWriter_impl.h    generated by: makeheader    Fri Apr 23 00:10:21 2021
 *
...
#define PRESPsWriter_setProperty(me, failReason, p, worker)                \
    (me)->_service->setLocalEndpointProperty( \
            (me)->_service, \
            failReason, \
            me, \
            p, \
            RTI_TRUE, /* propagateThroughDiscovery */ \
            worker)

#define PRESPsWriter_setPropertyEx( \
        me, \
        failReason, \
        p, \
        propagateThroughDiscovery, \
        worker) \
    (me)->_service->setLocalEndpointProperty( \
            (me)->_service, \
            failReason, \
...
#define PRESPsReader_setPropertyEx( \
        me, \
        failReason, \
        p, \
        propagateThroughDiscovery, \
...
PRESDllExport
RTIBool PRESPsWriter_writeInternal(
