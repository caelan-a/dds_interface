...
/*
 * @(#)pres_typePlugin.h    generated by: makeheader    Fri Apr 23 00:10:25 2021
 *
...
struct PRESTypePluginEndpointInfo {
    ...
    /* (Reader) Indicates if loaned fstSampleDataPool is used */
    RTIBool usesFstSampleDataPool;

    /* (Writer) Indicates if the payload will be encoded */
    RTIBool isPayloadProtected;

    /* (Writer) Pointer to the compression plugin if compression is needed */
...
extern PRESDllExport RTIBool
PRESTypePluginDefaultEndpointData_isCompressionEnabled(
    PRESTypePluginEndpointData endpointData);
 ...
 * plugin level.
 */
#define NDDS_DWHISTORY_MEMORYMANAGER_FASTPOOL_POOLBUFFERMAXSIZE PROPERTY_NAME_DDS_DATA_WRITER_HISTORY_MEMORY_MANAGER_FAST_POOL_POOL_BUFFER_MAX_SIZE
 ...
 */
#define NDDS_DRHISTORY_MEMORYMANAGER_FASTPOOL_POOLBUFFERMAXSIZE \
    PROPERTY_NAME_DDS_DATA_READER_HISTORY_MEMORY_MANAGER_FAST_POOL_POOL_BUFFER_MAX_SIZE
 ...
 */
#define NDDS_DWHISTORY_MEMORYMANAGER_FASTPOOL_POOLMAXBUFFERS PROPERTY_NAME_DDS_DATA_WRITER_HISTORY_MEMORY_MANAGER_FAST_POOL_POOL_MAX_BUFFERS
 ...
 */
#define NDDS_DWHISTORY_MEMORYMANAGER_FASTPOOL_POOLINITIALBUFFERS PROPERTY_NAME_DDS_DATA_WRITER_HISTORY_MEMORY_MANAGER_FAST_POOL_POOL_INITIAL_BUFFERS
 ...
 */
#define NDDS_DWHISTORY_MEMORYMANAGER_FASTPOOL_DYNAMICMEMORYMAXBYTES PROPERTY_NAME_DDS_DATA_WRITER_HISTORY_MEMORY_MANAGER_FAST_POOL_DYNAMIC_MEMORY_MAX_BYTES
 ...
 */
#define NDDS_DWHISTORY_MEMORYMANAGER_FASTPOOL_BUFFERGETMODE PROPERTY_NAME_DDS_DATA_WRITER_HISTORY_MEMORY_MANAGER_FAST_POOL_BUFFER_GET_MODE
 ...
 */
#define NDDS_DWHISTORY_MEMORYMANAGER_FASTPOOL_BUFFERRETURNMODE PROPERTY_NAME_DDS_DATA_WRITER_HISTORY_MEMORY_MANAGER_FAST_POOL_BUFFER_RETURN_MODE

/* Indicates whether serialization buffer must be obtained
 */
#define NDDS_DWHISTORY_MEMORYMANAGER_FASTPOOL_ZEROCOPY PROPERTY_NAME_DDS_DATA_WRITER_HISTORY_MEMORY_MANAGER_FAST_POOL_ZERO_COPY
 ...
 */
#define NDDS_DWHISTORY_MEMORYMANAGER_ENFORCE_MAX_DATA_BYTES PROPERTY_NAME_DDS_DATA_WRITER_HISTORY_MEMORY_MANAGER_BATCH_ENFORCE_MAX_DATA_BYTES
...
typedef PRESTypePluginKeyKind (*PRESTypePluginGetKeyKindFunction) (void);
...
typedef void (*PRESTypePluginSetDefaultParameterValuesFunction)
        (void *parameter,
        const struct MIGInterpreterContext *rtpsContext);
...
extern PRESDllExport
RTIBool PRESTypePlugin_interpretedInstanceToKeyHash(
        PRESTypePluginEndpointData endpointData,
        struct MIGRtpsKeyHash *keyhash,
        const void *instance,
        RTIEncapsulationId encapsulationId);
