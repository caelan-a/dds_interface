...
/*
 * @(#)dl_driver_odbc.h    generated by: makeheader    Fri Apr 23 00:06:22 2021
 *
 *		built from:	odbc.ifc
 */
...
#include <sqltypes.h>
#include <sqlext.h>
#if defined RTI_RTISQLITE3_ARCHITECTURE
...
typedef FARPROC SQLSetAllocatorFcn;
...
#if defined RTI_RTISQLITE3_ARCHITECTURE
typedef SQLRETURN (*SQLSetAllocatorFcn)(
        const struct RTISqlAllocator *allocator);
#endif
...
#if defined RTI_RTISQLITE3_ARCHITECTURE
    SQLSetAllocatorFcn setAllocatorFcn;
#else
    void *dummy;
#endif
