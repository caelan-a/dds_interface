...
/*
 * @(#)dds_cpp_domain.h    generated by: makeheader    Fri Apr 23 00:38:52 2021
 *
...
class DDSCPPDllExport DDSDomainParticipant : public DDSEntity {
  ...
  public:
    ...
    /*e \dref_DomainParticipant_get_dns_tracker_polling_period
     */
    virtual DDS_ReturnCode_t get_dns_tracker_polling_period(
            DDS_Duration_t& polling_period) = 0;

    /*e \dref_DomainParticipant_set_dns_tracker_polling_period
     */
    virtual DDS_ReturnCode_t set_dns_tracker_polling_period(
            const DDS_Duration_t& polling_period) = 0;
...
class DDSCPPDllExport DDSDomainParticipantFactory {
  ...
  // --- << entity configuration>>: -------------------------------------
  public:
    /*e \dref_DomainParticipantFactory_get_typecode_from_config
     */
    virtual const DDS_TypeCode * get_typecode_from_config(
        const char * type_name) = 0;
