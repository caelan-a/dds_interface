...
/*
 * @(#)dds_cpp_publication.h    generated by: makeheader    Fri Apr 23 00:38:52 2021
 *
...
class DDSCPPDllExport DDSDataWriter : public DDSDomainEntity {
  ...
  public:
    ...
    /*e \dref_DataWriter_is_matched_subscription_active */
    virtual DDS_ReturnCode_t is_matched_subscription_active(
            DDS_Boolean& is_active,
            const DDS_InstanceHandle_t& subscription_handle) {
        return _impl->is_matched_subscription_active(
                is_active,
                subscription_handle);
    }
