...
/*
 * @(#)dds_cpp_subscription.h    generated by: makeheader    Fri Apr 23 00:38:53 2021
 *
...
class DDSCPPDllExport DDSDataReader : public DDSDomainEntity {
  ...
  public:
    ...
    /*e \dref_DataReader_is_matched_publication_alive */
    virtual DDS_ReturnCode_t is_matched_publication_alive(
            DDS_Boolean& is_alive,
            const DDS_InstanceHandle_t& publication_handle) {
        return _impl->is_matched_publication_alive(is_alive, publication_handle);
    }
