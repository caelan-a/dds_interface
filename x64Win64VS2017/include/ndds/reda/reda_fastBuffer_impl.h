...
/*
 * @(#)reda_fastBuffer_impl.h    generated by: makeheader    Fri Apr 23 00:10:54 2021
 *
...
#define REDAFastBufferPool_newForStructure(structType, \
                                           propertyIn) \
    REDAFastBufferPool_newWithParams( \
            sizeof(structType), \
            ...
            (propertyIn), \
            (#structType), \
            REDA_FAST_BUFFER_POOL_FLAGS_NONE)
...
#define REDAFastBufferPool_new( \
    ...
    REDAFastBufferPool_newWithParams( \
            ...
            (propertyIn), \
            (#bufferAlignment),\
            REDA_FAST_BUFFER_POOL_FLAG_USE_IMPLICIT_TYPE_NAME)

#define REDAFastBufferPool_newWithNotification( \
        bufferSize, \
        bufferAlignment, \
        bufferInitializeFnc, \
        bufferInitializeParam, \
        bufferFinalizeFnc, \
        bufferFinalizeParam, \
        propertyIn) \
    REDAFastBufferPool_newWithParams( \
