...
/*
 * @(#)reda_database.h    generated by: makeheader    Fri Apr 23 00:10:54 2021
 *
...
extern REDADllExport
RTIBool REDADatabase_findTable(
        struct REDADatabase *me,
        struct REDAWeakReference *tableReference,
        const char *tableName,
        struct REDAWorker *worker);
...
extern REDADllExport
RTIBool REDADatabase_listTables(
        struct REDADatabase *me,
        struct REDAWorker *worker);

extern REDADllExport
RTIBool REDADatabase_listRecords(
        struct REDADatabase *database,
        const struct REDAWeakReference *tableReference,
        const char *tableName,
        RTIBool useCompactPrintFormat,
        RTIBool printAdminArea,
        struct REDAWorker *worker);

extern REDADllExport
struct REDAExclusiveArea * REDADatabase_createExclusiveArea(
        struct REDADatabase *database,
        int level,
        struct REDAWorker *worker);

extern REDADllExport
struct REDAExclusiveArea * REDADatabase_createExclusiveAreaEx(
        struct REDADatabase *database,
        int level,
        const char *name,
        struct REDAWorker *worker);
...
extern REDADllExport void
REDADatabaseInfo_print(struct REDADatabaseInfo *me, int indent);
