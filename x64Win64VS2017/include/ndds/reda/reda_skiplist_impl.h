...
/*
 * @(#)reda_skiplist_impl.h    generated by: makeheader    Fri Apr 23 00:10:56 2021
 *
...
{ \
  ...
  #define REDASkiplist_sizeOfSkiplistNode(level) \
    (sizeof(struct REDASkiplistNode) + \
     (size_t) (level) * sizeof(struct REDASkiplistNode *))
...
{                                                                        \
    ...
    register void *__userData = (self)->userData;                          \
	...
	while (((nextNode =                                              \
	       ...
	       ((compResult = ((self)->_isBuiltinCompareFcn) ?           \
                                ...
                                compareFncWithUserData(nextNode->userData,inKey,__userData) :     \
...
{                                                                             \
    ...
    if ((void *) preciseMatch != NULL) {                                      \
        *((RTIBool *) preciseMatch) = (compResult == 0);                       \
    }                                                                         \
    *(answer) = nextNode;                                                     \
}
