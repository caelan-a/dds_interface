...
/*
 * @(#)reda_cursor.h    generated by: makeheader    Fri Apr 23 00:10:54 2021
 *
...
extern REDADllExport
void REDACursor_printKey(
        const struct REDACursor *me,
        const char *desc,
        int indent);

extern REDADllExport
void REDACursor_printReadOnlyArea(
        const struct REDACursor *me,
        const char *desc,
        int indent);

extern REDADllExport
void REDACursor_printReadWriteArea(
        struct REDACursor *me,
        const char *desc,
        int indent);

extern REDADllExport
void REDACursor_printAdminArea(
        struct REDACursor *c,
        const char *desc,
        int indent);
