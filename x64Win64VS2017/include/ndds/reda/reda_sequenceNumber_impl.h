...
/*
 * @(#)reda_sequenceNumber_impl.h    generated by: makeheader    Fri Apr 23 00:10:55 2021
 *
...
#define reda_sequenceNumber_impl_h
  ...
  #define REDASequenceNumber_expand(__sequenceNumber) \
    (__sequenceNumber)->high, \
    (__sequenceNumber)->low
  ...
  ( (double)((sn)->low) + ((double)((sn)->high) * 4294967296.0) ) 
