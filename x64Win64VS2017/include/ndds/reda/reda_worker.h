...
/*
 * @(#)reda_worker.h    generated by: makeheader    Fri Apr 23 00:11:20 2021
 *
...
extern REDADllExport 
void REDAWorkerFactory_destroyWorker(
        struct REDAWorkerFactory *workerFactory,
        struct REDAWorker *worker);

extern REDADllExport 
void REDAWorkerFactory_destroyWorkerEx(
        struct REDAWorkerFactory *workerFactory,
        struct REDAWorker *worker,
...
extern REDADllExport
struct REDAExclusiveArea *REDAWorkerFactory_createExclusiveAreaEx(
        struct REDAWorkerFactory *workerFactory,
        int level,
        const char *name);
...
extern REDADllExport
struct RTIOsapiContext * REDAWorker_getActivityContext(
        const struct REDAWorker *worker);
...
extern REDADllExport
RTIBool REDAWorker_setName(
        struct REDAWorker *worker,
        const char *name);


#define REDA_WORKER_TIME_BASED_LOGGING_EXCLUSIVE_AREA_TRACKED_LEVEL_DEFAULT 10

extern REDADllExport
void REDAWorker_setEaTimeBasedLoggingLevelAndThreshold(
        struct REDAWorkerFactory *workerFactory,
        int eaTimeBasedLoggingLevel,
        int eaTimeBasedLoggingThresholdSeconds);

extern REDADllExport
RTIBool REDAWorker_associateThread(
        struct REDAWorker *worker,
        RTI_UINT32 workerTssKey);
...
extern REDADllExport void
REDAWorkerInfo_print(struct REDAWorkerInfo *info, int indent);
...
extern REDADllExport
struct REDAWorker * REDAWorkerPerThread_createWorker(
...
#define RTI_OSAPI_WORKER_NAME_MAX_SIZE 20 +  RTI_OSAPI_THREAD_NAME_MAX_SIZE

extern REDADllExport
struct REDAWorkerFactory * REDAWorkerGlobals_getWorkerFactory(void);

extern REDADllExport
void REDAWorkerGlobals_setWorkerFactory(
        struct REDAWorkerFactory *workerFactory);
