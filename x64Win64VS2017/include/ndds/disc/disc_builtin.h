...
/*
 * @(#)disc_builtin.h    generated by: makeheader    Fri Apr 23 00:06:21 2021
 *
...
#define DISC_BUILTIN_ENABLE_RTPS_DISCOVERY_OPTIMIZATION "DiscBERDO"

/* Participant properties */
#define DISC_BUILTIN_PARTICIPANT_PROPERTY_LENGTH (7)
...
#define DISC_BUILTIN_SUBSCRIPTION_PROPERTY_LENGTH (18)
...
struct DISCBuiltinTopicSubscriptionDataPool {
    ...
    RTIBool _enableRtpsDiscoveryOptimization;
};
...
DISCBuiltinTopicSubscriptionDataPluginSupport_createData(void);
...
DISCBuiltinTopicSubscriptionDataPlugin_getKeyKind(void);

extern DISCDllExport struct PRESTypePlugin **
DISCBuiltinTopicSubscriptionDataPlugin_assert(void);
...
extern DISCDllExport PRESTypePluginKeyKind 
DISCBuiltinTopicPublicationDataPlugin_getKeyKind(void);
...
extern DISCDllExport struct PRESTypePlugin**
DISCBuiltinTopicPublicationDataPlugin_assert(void);
...
DISCBuiltinTopicParticipantDataPluginSupport_createData(void);
...
extern DISCDllExport PRESTypePluginKeyKind 
DISCBuiltinTopicParticipantDataPlugin_getKeyKind(void);

extern DISCDllExport struct PRESTypePlugin **
DISCBuiltinTopicParticipantDataPlugin_assert(void);
