...
/*
 * @(#)ndds_namespace_cpp.h    generated by: makeheader    Fri Apr 23 00:38:54 2021
 *
...
namespace DDS {
    ...
    extern DDSCPPDllVariable const DDS_SampleFlagBits WRITER_REMOVED_BATCH_SAMPLE;
    extern DDSCPPDllVariable const DDS_SampleFlagBits DISCOVERY_SERVICE_SAMPLE;

    typedef DDS_SampleFlag            SampleFlag;
    typedef DDS_WriteParams_t         WriteParams_t;

    typedef DDS_CoherentSetInfo_t     CoherentSetInfo_t;
    ...
    extern DDSCPPDllVariable const DDS_CoherentSetInfo_t &COHERENTSETINFO_DEFAULT;

    extern DDSCPPDllVariable const DDS_GUID_t &GUID_UNKNOWN;
    extern DDSCPPDllVariable const DDS_GUID_t &GUID_AUTO;
    extern DDSCPPDllVariable const DDS_GUID_t &GUID_ZERO;
    ...
    /*i Not used. We keep it because it is in the spec */
    ...
    extern DDSCPPDllVariable const DDS_SampleRejectedStatusKind REJECTED_BY_DECODE_FAILURE;
    ...
    extern DDSCPPDllVariable const DDS_SampleLostStatusKind LOST_BY_UNKNOWN_INSTANCE;
    extern DDSCPPDllVariable const DDS_SampleLostStatusKind LOST_BY_DESERIALIZATION_FAILURE;
    extern DDSCPPDllVariable const DDS_SampleLostStatusKind LOST_BY_DECODE_FAILURE;
    extern DDSCPPDllVariable const DDS_SampleLostStatusKind LOST_BY_SAMPLES_PER_INSTANCE_LIMIT;
    extern DDSCPPDllVariable const DDS_SampleLostStatusKind LOST_BY_SAMPLES_LIMIT;
    ...
    typedef DDS_ReliabilityQosPolicyAcknowledgmentModeKind    ReliabilityQosPolicyAcknowledgmentModeKind;
    extern DDSCPPDllVariable const DDS_ReliabilityQosPolicyAcknowledgmentModeKind PROTOCOL_ACKNOWLEDGMENT_MODE;
    extern DDSCPPDllVariable const DDS_ReliabilityQosPolicyAcknowledgmentModeKind APPLICATION_AUTO_ACKNOWLEDGMENT_MODE;
    extern DDSCPPDllVariable const DDS_ReliabilityQosPolicyAcknowledgmentModeKind APPLICATION_EXPLICIT_ACKNOWLEDGMENT_MODE;
    ...
    extern DDSCPPDllVariable const DDS_TransportBuiltinKind TRANSPORTBUILTIN_UDPv4_WAN;
    ...
    extern DDSCPPDllVariable const char *const &TRANSPORTBUILTIN_UDPv4_WAN_ALIAS;
    ...
    typedef DDS_DataReaderResourceLimitsInstanceReplacementSettings DataReaderResourceLimitsInstanceReplacementSettings;
    ...
    typedef DDS_CompressionId_t CompressionId_t;
    extern DDSCPPDllVariable const CompressionId_t &COMPRESSION_ID_MASK_ALL;
    extern DDSCPPDllVariable const CompressionId_t &COMPRESSION_ID_MASK_NONE;
    extern DDSCPPDllVariable const CompressionId_t &COMPRESSION_ID_ZLIB;
    extern DDSCPPDllVariable const CompressionId_t &COMPRESSION_ID_BZIP2;
    extern DDSCPPDllVariable const CompressionId_t &COMPRESSION_ID_LZ4;
    typedef DDS_CompressionIdMaskBits CompressionIdMaskBits;
    typedef DDS_CompressionIdMask CompressionIdMask;
    typedef DDS_CompressionSettings_t CompressionSettings_t;
    ...
    extern DDSCPPDllVariable const DDS_QosPrintAll_t QOS_PRINT_ALL;
...
/* *********************** BuiltinQosProfilesLibrary *********************** */
    ...
    extern DDSCPPDllVariable const char *const &PROFILE_BASELINE_6_1_0;
...
/* ***************** BuiltinQosSnippetLibrary ***************** */
    extern DDSCPPDllVariable const char *const &BUILTIN_QOS_SNIPPET_LIB;
    extern DDSCPPDllVariable const char *const &SNIPPET_OPTIMIZATION_RELIABILITY_PROTOCOL_COMMON;
    extern DDSCPPDllVariable const char *const &SNIPPET_OPTIMIZATION_RELIABILITY_PROTOCOL_KEEP_ALL;
    extern DDSCPPDllVariable const char *const &SNIPPET_OPTIMIZATION_RELIABILITY_PROTOCOL_KEEP_LAST;
    extern DDSCPPDllVariable const char *const &SNIPPET_OPTIMIZATION_RELIABILITY_PROTOCOL_HIGH_RATE;
    extern DDSCPPDllVariable const char *const &SNIPPET_OPTIMIZATION_RELIABILITY_PROTOCOL_LOW_LATENCY;
    extern DDSCPPDllVariable const char *const &SNIPPET_OPTIMIZATION_RELIABILITY_PROTOCOL_LARGE_DATA;
    extern DDSCPPDllVariable const char *const &SNIPPET_OPTIMIZATION_DATACACHE_LARGE_DATA_DYNAMICMEMALLOC;
    extern DDSCPPDllVariable const char *const &SNIPPET_OPTIMIZATION_DISCOVERY_COMMON;
    extern DDSCPPDllVariable const char *const &SNIPPET_OPTIMIZATION_DISCOVERY_PARTICIPANT_COMPACT;
    extern DDSCPPDllVariable const char *const &SNIPPET_OPTIMIZATION_DISCOVERY_ENDPOINT_FAST;
    extern DDSCPPDllVariable const char *const &SNIPPET_OPTIMIZATION_TRANSPORT_LARGE_BUFFERS;
    extern DDSCPPDllVariable const char *const &SNIPPET_QOS_POLICY_RELIABILITY_RELIABLE;
    extern DDSCPPDllVariable const char *const &SNIPPET_QOS_POLICY_RELIABILITY_BEST_EFFORT;
    extern DDSCPPDllVariable const char *const &SNIPPET_QOS_POLICY_HISTORY_KEEP_LAST_1;
    extern DDSCPPDllVariable const char *const &SNIPPET_QOS_POLICY_HISTORY_KEEP_ALL;
    extern DDSCPPDllVariable const char *const &SNIPPET_QOS_POLICY_PUBLISH_MODE_ASYNCHRONOUS;
    extern DDSCPPDllVariable const char *const &SNIPPET_QOS_POLICY_DURABILITY_TRANSIENT_LOCAL;
    extern DDSCPPDllVariable const char *const &SNIPPET_QOS_POLICY_DURABILITY_TRANSIENT;
    extern DDSCPPDllVariable const char *const &SNIPPET_QOS_POLICY_DURABILITY_PERSISTENT;
    extern DDSCPPDllVariable const char *const &SNIPPET_QOS_POLICY_BATCHING_ENABLE;
    extern DDSCPPDllVariable const char *const &SNIPPET_FEATURE_FLOW_CONTROLLER_838MBPS;
    extern DDSCPPDllVariable const char *const &SNIPPET_FEATURE_FLOW_CONTROLLER_209MBPS;
    extern DDSCPPDllVariable const char *const &SNIPPET_FEATURE_FLOW_CONTROLLER_52MBPS;
    extern DDSCPPDllVariable const char *const &SNIPPET_FEATURE_AUTO_TUNING_ENABLE;
    extern DDSCPPDllVariable const char *const &SNIPPET_FEATURE_MONITORING_ENABLE;
    extern DDSCPPDllVariable const char *const &SNIPPET_FEATURE_SECURITY_ENABLE;
    extern DDSCPPDllVariable const char *const &SNIPPET_FEATURE_TOPIC_QUERY_ENABLE;
    extern DDSCPPDllVariable const char *const &SNIPPET_TRANSPORT_TCP_LAN_CLIENT;
    extern DDSCPPDllVariable const char *const &SNIPPET_TRANSPORT_TCP_WAN_SYMMETRIC_CLIENT;
    extern DDSCPPDllVariable const char *const &SNIPPET_TRANSPORT_TCP_WAN_ASYMMETRIC_SERVER;
    extern DDSCPPDllVariable const char *const &SNIPPET_TRANSPORT_TCP_WAN_ASYMMETRIC_CLIENT;
    extern DDSCPPDllVariable const char *const &SNIPPET_COMPATIBILITY_CONNEXT_MICRO_VERSION_2_4_3;
    extern DDSCPPDllVariable const char *const &SNIPPET_COMPATIBILITY_OTHER_DDS_VENDORS_ENABLE;
    extern DDSCPPDllVariable const char *const &SNIPPET_5_1_0_TRANSPORT_ENABLE;
}
