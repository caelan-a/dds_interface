...
/*
 * @(#)event_generator.h    generated by: makeheader    Fri Apr 23 00:06:23 2021
 *
...
#define RTIEventGeneratorListenerStorage_INITIALIZER \
    { \
        {NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL} /* field */ \
    }
...
struct RTIEventGeneratorProperty {
    ...
    */
    ...
    /*i
     * Time Based Logging.
     * Print a warning message when the event start/execution is delayed more
     * time than the threashold.
     * Default: INFINITE
     */
    RTINtpTime eventTimeThreshold;
};
...
{ \
    ...
    {RTI_NTP_TIME_SEC_MAX, RTI_NTP_TIME_FRAC_AUTO} /* eventTimeThreshold */ \
}
