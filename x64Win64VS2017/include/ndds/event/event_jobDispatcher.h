...
/*
 * @(#)event_jobDispatcher.h    generated by: makeheader    Fri Apr 23 00:06:23 2021
 *
...
struct RTIEventJobDispatcherProperty {
    ...
    */
    ...
    /*e
     * Max. time (in seconds) we wait for the destruction of the execution
     * thread upon a destroyThread() call. After this time, destroyThread() will
     * return without destroying execution thread's resources. When this
     * happens, we will rely on the JobDispatcher shutdown call to release these
     * resources.
     */
    RTI_INT32 executionThreadDestructionTimeout;
};
...
#define RTI_EVENT_JOB_DISPATCHER_PROPERTY_DEFAULT { \
    ...
    "#####", /* threadParticipantId */ \
    10, /* executionThreadDestructionTimeout */ \
}
...
struct RTIEventJobDispatcher *RTIEventJobDispatcher_new(
    ...
    const struct RTIEventJobDispatcherProperty *property);
...
RTIBool RTIEventJobDispatcher_removeThread(
    struct RTIEventJobDispatcher *me, struct RTIEventJobDispatcherThread *executionThread);
...
void RTIEventJobDispatcher_scheduleJob(
    ...
    int *unitsRequested,
    const struct RTIEventJobDispatcherStorage *scheduleStorage);
