...
/*
 * @(#)mig_generator.h    generated by: makeheader    Fri Apr 23 00:06:31 2021
 *
...
struct MIGCoherentSetInfo {
    /*
     * Sequence number of first sample in set to which this sample
     * belongs; will be UNKNOWN if this sample does not belong to a set 
     */
    struct REDASequenceNumber setFirstSn;
    
    /*
     * The group sequence number of the first sample in a coherent set.
     * This value will be set for samples that are part of a coherent set
     * when the access scope on a Publisher is set to 
...
#define MIGCoherentSetInfo_INITIALIZER { \
    REDA_SEQUENCE_NUMBER_UNKNOWN, \
    REDA_SEQUENCE_NUMBER_UNKNOWN \
}

 extern MIGDllVariable 
const struct MIGCoherentSetInfo MIG_COHERENT_SET_INFO_UNKNOWN;
...
struct MIGGeneratorSample {
    ...
    struct MIGCoherentSetInfo coherentSetInfo;
...
#define MIG_SESSION_ID_UNKNOWN (-2)
  ...
  #define MIG_GENERATOR_SAMPLE_DEFAULT { \
     ...
     MIGCoherentSetInfo_INITIALIZER, /* coherentSetInfo */ \
...
extern MIGDllExport 
RTIBool MIGGeneratorSample_set(
        struct MIGGeneratorSample *me,
        const struct REDASequenceNumber *sn,
        const struct MIGCoherentSetInfo *coherentSetInfo,
...
struct MIGGeneratorSecurityProperty {
    ...
    /*e
     * \brief Represents the remote key material list used to encode a directed
     *  submessage. At a given point, this list includes ONE handle
     *  corresponding to the remote endpoint a submessage is directed to.
     */
    struct REDAInlineList directedRemoteEndpointInterceptorHandleList;
    /*e
     * \brief Represents the remote key material list used to encode a
     *  message.  At a given point, this list includes the handles corresponding
     *  to the remote participants an RTPS message is directed to.
     */
...
#define MIG_GENERATOR_SECURITY_ENCODE_BUFFER_MAX_SIZE         65536
...
extern MIGDllExport
struct MIGGenerator * MIGGenerator_new(
...
MIGGenerator_addAck(
        ...
        const struct MIGInterceptorHandles *writerDirectedInterceptorHandles,
...
extern MIGDllExport
RTIBool MIGGenerator_addNackFrag(
        struct MIGGenerator *me,
        int *size,
        char flags,
        MIGRtpsObjectId readerObjectId,
...
extern MIGDllExport
RTIBool MIGGenerator_addGap(
        struct MIGGenerator *me,
        int *size,
        char flags,
        const struct MIGRtpsGuid *readerGuidIn,
        MIGRtpsObjectId writerObjectId,
        const struct MIGInterceptorHandles *readerDirectedInterceptorHandles,
        const struct REDASequenceNumber *sequenceNumber,
        const struct MIGRtpsBitmap *bitmap,
        struct REDAWorker *worker);

extern MIGDllExport
RTIBool MIGGenerator_addHeartbeat(
        struct MIGGenerator *me, char flags,
        const struct MIGRtpsGuid *readerGuidIn,
        MIGRtpsObjectId writerObjectId,
        const struct MIGInterceptorHandles *readerDirectedInterceptorHandles,
...
extern MIGDllExport
RTIBool MIGGenerator_addHeartbeatVirtual(
        struct MIGGenerator *me,
        char flags,
        const struct MIGRtpsGuid *readerGuidIn,
        MIGRtpsObjectId writerObjectId,
...
extern MIGDllExport
RTIBool MIGGenerator_addInfoDestination(
        struct MIGGenerator *me,
        char flags,
...
extern MIGDllExport
RTIBool MIGGenerator_addDataSession(
        struct MIGGenerator *me,
        int *size,
        const struct MIGRtpsGuid *readerGuidIn,
        MIGRtpsObjectId writerObjectId,
...
extern MIGDllExport
RTIBool MIGGenerator_addDataBatch(
        struct MIGGenerator *me,
        int *size,
        const struct MIGRtpsGuid *readerGuidIn,
        MIGRtpsObjectId writerObjectId,
...
extern MIGDllExport
RTIBool MIGGenerator_addDataFrag(
        struct MIGGenerator *me,
        int *size,
        const struct MIGRtpsGuid *readerGuidIn,
        MIGRtpsObjectId writerObjectId,
...
extern MIGDllExport
RTIBool MIGGenerator_addDataFragEx(
        struct MIGGenerator *me,
        int *size,
        const struct MIGRtpsGuid *readerGuidIn,
        MIGRtpsObjectId writerObjectId,
        ...
        const struct MIGGeneratorSample *sample,
        int numFragsToAdd,
        RTI_INT32 firstFragNumber,
        int fragSize,
        int *numFragsAdded,
        RTIBool use43DataFragFormat,
        int encapsulationIndex,
        RTIBool addVirtualSn,
        struct REDAWorker *worker);
...
extern MIGDllExport
RTIBool MIGGenerator_addAppAckConf(
        struct MIGGenerator *me,
        char flags,
        const struct MIGRtpsGuid *readerGuidIn,
        MIGRtpsObjectId writerObjectId,
