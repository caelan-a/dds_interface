...
/*
 * @(#)rti_dl_c.h    generated by: makeheader    Fri Apr 23 01:06:21 2021
 *
 *		built from:	c.ifc
 */
...
extern RTIDLCDllExport DDS_Long RTI_DL_DistLogger_get_fatal_log_level(void);

extern RTIDLCDllExport DDS_Long RTI_DL_DistLogger_get_error_log_level(void);

extern RTIDLCDllExport DDS_Long RTI_DL_DistLogger_get_warning_log_level(void);

extern RTIDLCDllExport DDS_Long RTI_DL_DistLogger_get_notice_log_level(void);

extern RTIDLCDllExport DDS_Long RTI_DL_DistLogger_get_info_log_level(void);

extern RTIDLCDllExport DDS_Long RTI_DL_DistLogger_get_debug_log_level(void);
